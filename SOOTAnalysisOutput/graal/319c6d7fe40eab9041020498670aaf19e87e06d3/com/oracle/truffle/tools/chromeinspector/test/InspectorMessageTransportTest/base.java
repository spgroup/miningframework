...
public class InspectorMessageTransportTest extends EnginesGCedTest {
    ...
    private static final String[] MESSAGES_TO_CLIENT = { "{\"result\":{},\"id\":5}", "{\"result\":{},\"id\":6}", "{\"result\":{},\"id\":7}", "{\"result\":{},\"id\":8}", "{\"result\":{},\"id\":20}", "{\"result\":{},\"id\":28}", "{\"method\":\"Runtime.executionContextCreated\"", "{\"method\":\"Debugger.paused\",", "{\"result\":{},\"id\":100}", "{\"method\":\"Debugger.resumed\"}" };
