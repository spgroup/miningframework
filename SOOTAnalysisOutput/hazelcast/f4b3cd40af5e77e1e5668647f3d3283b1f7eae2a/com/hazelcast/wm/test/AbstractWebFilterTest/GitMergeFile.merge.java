...
public abstract class AbstractWebFilterTest extends HazelcastTestSupport {
    ...
    protected static final Map<Class<? extends AbstractWebFilterTest>, ContainerContext> CONTAINER_CONTEXT_MAP = new HashMap<Class<? extends AbstractWebFilterTest>, ContainerContext>();
    ...
    public static void teardownClass() throws Exception {
        for (Map.Entry<Class<? extends AbstractWebFilterTest>, ContainerContext> ccEntry : CONTAINER_CONTEXT_MAP.entrySet()) {
    ...
    protected String executeRequest(RequestType reqType, String context, int serverPort, CookieStore cookieStore) throws Exception {
    ...
    String getHazelcastSessionId(CookieStore cookieStore) {
        for (Cookie cookie : cookieStore.getCookies()) {
            ...
            if ("hazelcast.sessionId".equals(name))
    ...
    protected static class ContainerContext {
        ...
        public ContainerContext(AbstractWebFilterTest test, String serverXml1, String serverXml2, int serverPort1, int serverPort2, ServletContainer server1, ServletContainer server2, HazelcastInstance hz) {
            this.test = test;
            this.serverXml1 = serverXml1;
            this.serverXml2 = serverXml2;
