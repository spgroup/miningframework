...
public class BLCMain implements EntryPoint {
    ...
    public static void addModule(Module module) {
        ...
        for (Section section : new ArrayList<Section>(((AbstractModule) module).getSections())) {
            ...
            ((AbstractModule) existingModule).setSection(section.getSectionTitle(), section.getSectionViewKey(), section.getSectionViewClass(), section.getSectionPresenterKey(), section.getSectionPresenterClass(), section.getSectionPermissions());
        }
    }
