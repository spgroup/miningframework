...
public class PerfDataEntry extends VMObject {
    ...
    public boolean booleanValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tBoolean, "not a boolean");
        }
    ...
    public char charValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tChar, "not a char");
        }
    ...
    public byte byteValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tByte, "not a byte");
        }
    ...
    public short shortValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tShort, "not a short");
        }
    ...
    public int intValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tInt, "not an int");
        }
    ...
    public long longValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tLong, "not a long");
        }
    ...
    public float floatValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tFloat, "not a float");
        }
    ...
    public double doubleValue() {
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(vectorLength() == 0 && dataType() == BasicType.tDouble, "not a double");
        }
    ...
    public boolean[] booleanArrayValue() {
        ...
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tBoolean, "not a boolean vector");
        }
    ...
    public char[] charArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tChar, "not a char vector");
        }
    ...
    public byte[] byteArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tByte, "not a byte vector");
        }
    ...
    public short[] shortArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tShort, "not a short vector");
        }
    ...
    public int[] intArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tInt, "not an int vector");
        }
        int[] res = new int[len];
        final int off = dataOffset();
    ...
    public long[] longArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tLong, "not a long vector");
        }
    ...
    public float[] floatArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tFloat, "not a float vector");
        }
    ...
    public double[] doubleArrayValue() {
        int len = vectorLength();
        if (Assert.ASSERTS_ENABLED) {
            Assert.that(len > 0 && dataType() == BasicType.tDouble, "not a double vector");
        }
