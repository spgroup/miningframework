...
public class FtpClient extends sun.net.ftp.FtpClient {
    ...
    private boolean issueCommand(String cmd) throws IOException, sun.net.ftp.FtpProtocolException {
        ...
        if (cmd.indexOf('\n') != -1) {
            sun.net.ftp.FtpProtocolException ex = new sun.net.ftp.FtpProtocolException("Illegal FTP command");
    ...
    private boolean sendSecurityData(byte[] buf) throws IOException, sun.net.ftp.FtpProtocolException {
