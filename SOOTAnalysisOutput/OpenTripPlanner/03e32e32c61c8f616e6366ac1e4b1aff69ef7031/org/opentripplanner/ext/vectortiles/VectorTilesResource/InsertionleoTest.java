...
>>>>>>> YOURS
    ...
    static {
        layers.put(LayerType.Stop, StopsLayerBuilder::new);
        layers.put(LayerType.Station, StationsLayerBuilder::new);
        layers.put(LayerType.VehicleRental, (graph, transitService, layerParameters) -> new VehicleRentalPlacesLayerBuilder(graph.getVehicleRentalStationService(), layerParameters));
        layers.put(LayerType.VehicleRentalStation, (graph, transitService, layerParameters) -> new VehicleRentalStationsLayerBuilder(graph.getVehicleRentalStationService(), layerParameters));
        layers.put(LayerType.VehicleRentalVehicle, (graph, transitService, layerParameters) -> new VehicleRentalVehiclesLayerBuilder(graph.getVehicleRentalStationService(), layerParameters));
        layers.put(LayerType.VehicleParking, VehicleParkingsLayerBuilder::new);
    }
    ...
    enum LayerType {
        ...
        VehicleParking, VehicleParkingGroup
    }
