...
class PrimitiveBinopOverload {
    ...
    long _plus(long x, long y) {
        return -1;
    }

    @Candidate(applicable = Phase.BASIC)
    float _plus(float x, float y) {
        return -1;
    }
    ...
    Object _plus(Object x, Object y) {
        return -1;
    }
    ...
    long _minus(long x, long y) {
        return -1;
    }

    @Candidate(applicable = { Phase.BASIC, Phase.BOX })
    float _minus(float x, float y) {
        return -1;
    }
