    ...
    private static final class HostsFileNameService implements NameService {
        ...
        public String getHostByAddr(byte[] addr) throws UnknownHostException {
            ...
            try (Scanner hostsFileScanner = new Scanner(new File(hostsFile), "UTF-8")) {
                ...
                throw new UnknownHostException("Unable to resolve address " + Arrays.toString(addr) + " as hosts file " + hostsFile + " not found ");
            }
            if ((host == null) || (host.isEmpty()) || (host.equals(" "))) {
                throw new UnknownHostException("Requested address " + Arrays.toString(addr) + " resolves to an invalid entry in hosts file " + hostsFile);
            }
            return host;
        }
