...
public class JSR166TestCase extends TestCase {
    ...
    public static boolean atLeastJava9() {
        return JAVA_CLASS_VERSION >= 53.0 || JAVA_SPECIFICATION_VERSION.matches("^(1\\.)?(9|[0-9][0-9])$");
    }

    public static boolean atLeastJava10() {
        return JAVA_CLASS_VERSION >= 54.0 || JAVA_SPECIFICATION_VERSION.matches("^(1\\.)?[0-9][0-9]$");
    }
    ...
    public static Test suite() {
        ...
        if (atLeastJava8()) {
            String[] java8TestClassNames = { "ArrayDeque8Test", "Atomic8Test", "CompletableFutureTest", "ConcurrentHashMap8Test", "CountedCompleter8Test", "DoubleAccumulatorTest", "DoubleAdderTest", "ForkJoinPool8Test", "ForkJoinTask8Test", "LinkedBlockingDeque8Test", "LinkedBlockingQueue8Test", "LongAccumulatorTest", "LongAdderTest", "SplittableRandomTest", "StampedLockTest", "SubmissionPublisherTest", "ThreadLocalRandom8Test", "TimeUnit8Test" };
