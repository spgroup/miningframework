...
public class cgBase {
    ...
    private final static SimpleDateFormat dateTbIn1 = new SimpleDateFormat("EEEEE, dd MMMMM yyyy", Locale.ENGLISH);

    private final static SimpleDateFormat dateTbIn2 = new SimpleDateFormat("EEEEE, MMMMM dd, yyyy", Locale.ENGLISH);
    ...
    private static List<cgLog> loadLogsFromDetails(final String page, final cgCache cache, final boolean friends) {
        ...
        final Parameters params = new Parameters("tkn", userToken, "idx", "1", "num", "35", "decrypt", "true", "sf", Boolean.toString(friends));
    ...
    public static Double getElevation(final Geopoint coords) {
        try {
            ...
            final Parameters params = new Parameters("sensor", "false", "locations", coords.format(Format.LAT_LON_DECDEGREE_COMMA));
