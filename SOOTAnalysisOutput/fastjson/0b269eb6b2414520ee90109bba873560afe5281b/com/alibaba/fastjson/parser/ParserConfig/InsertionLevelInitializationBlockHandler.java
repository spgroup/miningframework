...
public class ParserConfig {
    ...
    private static Function<Class<?>, Boolean> isPrimitiveFuncation = new Function<Class<?>, Boolean>() {
        ...
        public Boolean apply(Class<?> clazz) {
            return clazz == java.sql.Date.class || clazz == java.sql.Time.class || clazz == java.sql.Timestamp.class;
        }
    };

    public static boolean isPrimitive2(final Class<?> clazz) {
        Boolean primitive = clazz.isPrimitive() || clazz == Boolean.class || clazz == Character.class || clazz == Byte.class || clazz == Short.class || clazz == Integer.class || clazz == Long.class || clazz == Float.class || clazz == Double.class || clazz == BigInteger.class || clazz == BigDecimal.class || clazz == String.class || clazz == java.util.Date.class || clazz.isEnum();
        if (!primitive) {
    ...
    public Class<?> checkAutoType(String typeName, Class<?> expectClass, int features) {
        ...
        final long h3 = (((((fnv1a_64_magic_hashcode ^ className.charAt(0)) * fnv1a_64_magic_prime) ^ className.charAt(1)) * fnv1a_64_magic_prime) ^ className.charAt(2)) * fnv1a_64_magic_prime;
        ...
        if (clazz != null) {
            if (expectClass != null && clazz != java.util.HashMap.class && clazz != java.util.LinkedHashMap.class && !expectClass.isAssignableFrom(clazz)) {
    ...
    public void addAutoTypeCheckHandler(AutoTypeCheckHandler h) {
        ...
        if (autoTypeCheckHandlers == null) {
            this.autoTypeCheckHandlers = autoTypeCheckHandlers = new CopyOnWriteArrayList();
        }
