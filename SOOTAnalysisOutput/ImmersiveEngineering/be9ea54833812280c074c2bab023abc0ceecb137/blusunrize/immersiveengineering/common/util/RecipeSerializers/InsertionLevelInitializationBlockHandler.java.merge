...
public class RecipeSerializers {
    ...
    public static final DeferredRegister<IRecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, ImmersiveEngineering.MODID);
    ...
    public static final RegistryObject<SpecialRecipeSerializer<PowerpackRecipe>> POWERPACK_SERIALIZER = RECIPE_SERIALIZERS.register("powerpack", () -> new SpecialRecipeSerializer<>(PowerpackRecipe::new));
    ...
    public static final RegistryObject<SpecialRecipeSerializer<EarmuffsRecipe>> EARMUFF_SERIALIZER = RECIPE_SERIALIZERS.register("earmuffs", () -> new SpecialRecipeSerializer<>(EarmuffsRecipe::new));
    ...
    public static final RegistryObject<SpecialRecipeSerializer<RevolverCycleRecipe>> REVOLVER_CYCLE_SERIALIZER = RECIPE_SERIALIZERS.register("revolver_cycle", () -> new SpecialRecipeSerializer<>(RevolverCycleRecipe::new));

    public static final RegistryObject<SpecialRecipeSerializer<IERepairItemRecipe>> IE_REPAIR = RECIPE_SERIALIZERS.register("ie_item_repair", () -> new SpecialRecipeSerializer<>(IERepairItemRecipe::new));
