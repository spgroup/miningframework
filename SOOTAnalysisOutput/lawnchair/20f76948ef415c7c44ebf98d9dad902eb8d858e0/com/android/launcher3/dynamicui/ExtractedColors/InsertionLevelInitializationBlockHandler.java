...
public class ExtractedColors {
    ...
    public void updateAllAppsGradientPalette(@Nullable Palette wallpaperPalette) {
        ...
        setColorAtIndex(idx, wallpaperPalette == null ? DEFAULT_VALUES[idx] : wallpaperPalette.getDarkVibrantColor(DEFAULT_VALUES[idx]));
        idx = ALLAPPS_GRADIENT_SECONDARY_INDEX;
        setColorAtIndex(idx, wallpaperPalette == null ? DEFAULT_VALUES[idx] : wallpaperPalette.getVibrantColor(DEFAULT_VALUES[idx]));
    }
}