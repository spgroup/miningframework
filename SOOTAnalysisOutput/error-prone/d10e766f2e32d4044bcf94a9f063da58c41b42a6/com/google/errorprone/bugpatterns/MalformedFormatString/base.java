...
public class MalformedFormatString extends BugChecker implements MethodInvocationTreeMatcher {
    ...
    private static final Matcher<ExpressionTree> isPrintfLike = anyOf(isDescendantOfMethod("java.io.PrintStream", "format(java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintStream", "printf(java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintWriter", "format(java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintWriter", "printf(java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.util.Formatter", "format(java.lang.String,java.lang.Object...)"), staticMethod("java.lang.String", "format(java.lang.String,java.lang.Object...)"));

    private static final Matcher<ExpressionTree> isPrintfLikeWithLocale = anyOf(isDescendantOfMethod("java.io.PrintStream", "format(java.util.Locale,java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintStream", "printf(java.util.Locale,java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintWriter", "printf(java.util.Locale,java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.io.PrintWriter", "format(java.util.Locale,java.lang.String,java.lang.Object...)"), isDescendantOfMethod("java.util.Formatter", "format(java.util.Locale,java.lang.String,java.lang.Object...)"), staticMethod("java.lang.String", "format(java.util.Locale,java.lang.String,java.lang.Object...)"));
    ...
    public Description matchMethodInvocation(MethodInvocationTree tree, VisitorState state) {
        ...
        if (formatArgs.size() == 1 && ((JCExpression) formatArgs.get(0)).type.getKind() == TypeKind.ARRAY) {
            return Description.NO_MATCH;
        }
        ...
        try {
            ...
            return new Description.Builder(tree, pattern).setMessage(message).setFix(fix).build();
        } catch (Exception e) {
        }
        return Description.NO_MATCH;
    }
