...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        SPARK_RPC_CLIENT_HANDSHAKE_TIMEOUT("hive.spark.client.server.connect.timeout", "20000ms", new TimeValidator(TimeUnit.MILLISECONDS), "Timeout for handshake between Hive client and remote Spark driver.  Checked by both processes."),
