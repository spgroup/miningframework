...
public abstract class HudsonTestCase extends TestCase implements RootAction {
    ...
    public void assertXPath(HtmlPage page, String xpath) {
        assertNotNull("There should be an object that matches XPath:" + xpath, DomNodeUtil.selectSingleNode(page.getDocumentElement(), xpath));
    }
    ...
    public class WebClient extends com.gargoylesoftware.htmlunit.WebClient {
        ...
        public WebRequest addCrumb(WebRequest req) {
            com.gargoylesoftware.htmlunit.util.NameValuePair crumb = new com.gargoylesoftware.htmlunit.util.NameValuePair(jenkins.getCrumbIssuer().getDescriptor().getCrumbRequestField(), jenkins.getCrumbIssuer().getCrumb(null));
