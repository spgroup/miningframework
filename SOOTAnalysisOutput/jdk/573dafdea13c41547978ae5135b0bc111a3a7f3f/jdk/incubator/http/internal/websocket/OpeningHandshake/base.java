...
final class OpeningHandshake {
    ...
    private static final String VALUE_VERSION = "13";
    ...
    private static String requireSingle(HttpHeaders responseHeaders, String headerName) throws CheckFailedException {
        List<String> values = responseHeaders.allValues(headerName);
        if (values.isEmpty()) {
