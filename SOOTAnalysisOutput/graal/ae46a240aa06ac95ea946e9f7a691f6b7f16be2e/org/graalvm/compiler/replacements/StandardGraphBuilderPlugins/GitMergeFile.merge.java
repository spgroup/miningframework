...
=======
        ...
        sr.register2("getByte", byte[].class, int.class, new InvocationPlugin() {
            ...
            @Override
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode arg1, ValueNode arg2) {
                b.addPush(JavaKind.Byte, new JavaReadNode(JavaKind.Byte, new IndexAddressNode(arg1, arg2, JavaKind.Byte), NamedLocationIdentity.getArrayLocation(JavaKind.Byte), OnHeapMemoryAccess.BarrierType.NONE, false));
>>>>>>> YOURS
                return true;
            }
        });
    ...
    static class StringEqualsInvocationPlugin extends InvocationPlugin {
        ...
        public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode other) {
            ...
            try (InvocationPluginHelper helper = new InvocationPluginHelper(b, targetMethod)) {
                ...
                GuardingNode stringArg2Guard = helper.emitReturnIfNot(InstanceOfNode.create(stringType, other), b.add(falseValue), BranchProbabilityNode.SLOW_PATH_PROBABILITY);
                ...
                helper.emitReturnIf(IntegerEqualsNode.create(thisLength, ConstantNode.forInt(0), NodeView.DEFAULT), trueValue, BranchProbabilityNode.SLOW_PATH_PROBABILITY);
                helper.emitFinalReturn(JavaKind.Boolean, b.append(new ArrayEqualsNode(thisValue, thatValue, thisLength.isConstant() ? thisLength : thatLength, JavaKind.Byte)));
            }
            return true;
        }
    }
    ...
    private static void registerUnsafePlugins(InvocationPlugins plugins, Replacements replacements, boolean explicitUnsafeNullChecks) {
        ...
        registerUnsafeAtomicsPlugins(new Registration(plugins, Unsafe.class), true, explicitUnsafeNullChecks, "compareAndSwap", new String[] { "" }, supportedJavaKinds);
            ...
            if ((kind.isPrimitive() && kind != JavaKind.Void) || kind == JavaKind.Object) {
                ...
                if (sunMiscUnsafe) {
                    if (kind == JavaKind.Int || kind == JavaKind.Long || kind == JavaKind.Object) {
                        r.register(new UnsafePutPlugin(kind, MemoryOrderMode.RELEASE, explicitUnsafeNullChecks, "putOrdered" + kindName, Receiver.class, Object.class, long.class, javaClass));
                    }
                } else {
                    r.register(new UnsafePutPlugin(kind, MemoryOrderMode.RELEASE, explicitUnsafeNullChecks, "put" + kindName + "Release", Receiver.class, Object.class, long.class, javaClass));
                    r.register(new UnsafeGetPlugin(kind, MemoryOrderMode.ACQUIRE, explicitUnsafeNullChecks, "get" + kindName + "Acquire", Receiver.class, Object.class, long.class));
                    r.register(new UnsafePutPlugin(kind, MemoryOrderMode.OPAQUE, explicitUnsafeNullChecks, "put" + kindName + "Opaque", Receiver.class, Object.class, long.class, javaClass));
                    r.register(new UnsafeGetPlugin(kind, MemoryOrderMode.OPAQUE, explicitUnsafeNullChecks, "get" + kindName + "Opaque", Receiver.class, Object.class, long.class));
                }
    ...
    public enum IntegerExactOp {
        ...
        INTEGER_ADD_EXACT, INTEGER_INCREMENT_EXACT, INTEGER_SUBTRACT_EXACT, INTEGER_DECREMENT_EXACT, INTEGER_MULTIPLY_EXACT
    }
    ...
    public static class UnsafeCompareAndSwapPlugin extends UnsafeAccessPlugin {
        ...
        public UnsafeCompareAndSwapPlugin(JavaKind returnKind, JavaKind accessKind, MemoryOrderMode memoryOrder, boolean isLogic, boolean explicitUnsafeNullChecks, String name, Type... argumentTypes) {
