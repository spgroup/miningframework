...
public class MVELCompilationUnit implements Externalizable, Cloneable {
    ...
    public DroolsMVELIndexedFactory getFactory(final KnowledgeHelper knowledgeHelper, final Rule rule, final Object rightObject, final LeftTuple tuples, final Object[] otherVars, final InternalWorkingMemory workingMemory) {
    ...
    public static Serializable compile(final String text, final ClassLoader classLoader, final ParserContext parserContext, final int languageLevel) {
    ...
    public MVELCompilationUnit clone() {
        return new MVELCompilationUnit(name, expression, pkgImports, importClasses, importMethods, importFields, globalIdentifiers, previousDeclarations, localDeclarations, otherIdentifiers, inputIdentifiers, inputTypes, languageLevel, strictMode);
    }
