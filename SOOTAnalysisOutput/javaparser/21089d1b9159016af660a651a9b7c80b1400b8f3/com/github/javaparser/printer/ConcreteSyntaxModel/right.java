...
public class ConcreteSyntaxModel {
    ...
    static {
        ...
        concreteSyntaxModelByClass.put(Name.class, sequence(comment(), conditional(ObservableProperty.QUALIFIER, IS_PRESENT, sequence(child(ObservableProperty.QUALIFIER), token(GeneratedJavaParserConstants.DOT))), list(ObservableProperty.ANNOTATIONS, space(), none(), space()), attribute(ObservableProperty.IDENTIFIER), orphanCommentsEnding()));
        ...
        concreteSyntaxModelByClass.put(ModuleDeclaration.class, sequence(memberAnnotations(), conditional(ObservableProperty.OPEN, FLAG, sequence(token(GeneratedJavaParserConstants.OPEN), space())), token(GeneratedJavaParserConstants.MODULE), space(), child(ObservableProperty.NAME), space(), token(GeneratedJavaParserConstants.LBRACE), newline(), indent(), list(ObservableProperty.MODULE_STMTS), unindent(), token(GeneratedJavaParserConstants.RBRACE), newline()));
        concreteSyntaxModelByClass.put(ModuleExportsStmt.class, sequence(token(GeneratedJavaParserConstants.EXPORTS), space(), child(ObservableProperty.NAME), list(ObservableProperty.MODULE_NAMES, sequence(comma(), space()), sequence(space(), token(GeneratedJavaParserConstants.TO), space()), none()), semicolon(), newline()));
        concreteSyntaxModelByClass.put(ModuleOpensStmt.class, sequence(token(GeneratedJavaParserConstants.OPENS), space(), child(ObservableProperty.NAME), list(ObservableProperty.MODULE_NAMES, sequence(comma(), space()), sequence(space(), token(GeneratedJavaParserConstants.TO), space()), none()), semicolon(), newline()));
        concreteSyntaxModelByClass.put(ModuleProvidesStmt.class, sequence(token(GeneratedJavaParserConstants.PROVIDES), space(), child(ObservableProperty.NAME), list(ObservableProperty.WITH, sequence(comma(), space()), sequence(space(), token(GeneratedJavaParserConstants.WITH), space()), none()), semicolon(), newline()));
        concreteSyntaxModelByClass.put(ModuleRequiresStmt.class, sequence(token(GeneratedJavaParserConstants.REQUIRES), space(), modifiers(), child(ObservableProperty.NAME), semicolon(), newline()));
        concreteSyntaxModelByClass.put(ModuleUsesStmt.class, sequence(token(GeneratedJavaParserConstants.USES), space(), child(ObservableProperty.NAME), semicolon(), newline()));
