...
public class CPoolRefClassContainingInlinedCts {
    ...
    void checkClassName(String className) {
        switch(className) {
            case "SimpleAssignClassA":
            case "BinaryExpClassA":
            case "UnaryExpClassA":
            case "CastClassA":
            case "ParensClassA":
            case "CondClassA":
            case "IfClassA":
            case "pkg/ClassToBeStaticallyImportedA":
            case "SimpleAssignClassB":
            case "BinaryExpClassB":
            case "UnaryExpClassB":
            case "CastClassB":
            case "ParensClassB":
            case "CondClassB":
            case "IfClassB":
            case "pkg/ClassToBeStaticallyImportedB":
