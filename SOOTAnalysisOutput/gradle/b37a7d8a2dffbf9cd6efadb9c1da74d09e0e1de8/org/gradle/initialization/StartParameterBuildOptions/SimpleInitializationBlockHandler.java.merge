...
public class StartParameterBuildOptions {
    ...
    public static class WatchFileSystemOption extends BooleanBuildOption<StartParameterInternal> {
        ...
        public WatchFileSystemOption() {
            super(GRADLE_PROPERTY, BooleanCommandLineOptionConfiguration.create(LONG_OPTION, "Enables watching the file system for changes, allowing data about the file system to be re-used for the next build.", "Disables watching the file system.").incubating());
        }
    ...
    public static class DependencyVerificationWriteOption extends StringBuildOption<StartParameterInternal> {
        ...
        DependencyVerificationWriteOption() {
            super(null, CommandLineOptionConfiguration.create(LONG_OPTION, SHORT_OPTION, "Generates checksums for dependencies used in the project (comma-separated list)").incubating());
        }
    ...
    public static class DependencyVerificationModeOption extends EnumBuildOption<DependencyVerificationMode, StartParameterInternal> {
        ...
        public DependencyVerificationModeOption() {
            super(LONG_OPTION, DependencyVerificationMode.class, DependencyVerificationMode.values(), GRADLE_PROPERTY, CommandLineOptionConfiguration.create(LONG_OPTION, SHORT_OPTION, "Configures the dependency verification mode (strict, lenient or off)").incubating());
        }
    ...
    public static class RefreshKeysOption extends EnabledOnlyBooleanBuildOption<StartParameterInternal> {
        ...
        public RefreshKeysOption() {
            super(null, CommandLineOptionConfiguration.create(LONG_OPTION, "Refresh the public keys used for dependency verification.").incubating());
        }
    ...
    public static class ExportKeysOption extends EnabledOnlyBooleanBuildOption<StartParameterInternal> {
        ...
        public ExportKeysOption() {
            super(null, CommandLineOptionConfiguration.create(LONG_OPTION, "Exports the public keys used for dependency verification.").incubating());
        }
    ...
    public static class ConfigurationCacheOption extends EnumBuildOption<ConfigurationCacheOption.Value, StartParameterInternal> {
        ...
        public ConfigurationCacheOption() {
            super(LONG_OPTION, Value.class, Value.values(), PROPERTY_NAME, CommandLineOptionConfiguration.create(LONG_OPTION, "Enables the configuration cache (off, on, or warn). Gradle will try to reuse the build configuration from previous builds.").incubating());
        }
