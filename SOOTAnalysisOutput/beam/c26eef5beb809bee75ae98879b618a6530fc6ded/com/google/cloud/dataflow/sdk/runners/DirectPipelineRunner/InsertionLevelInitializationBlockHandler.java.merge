...
public class DirectPipelineRunner extends PipelineRunner<DirectPipelineRunner.EvaluationResults> {
    ...
    public <OutputT extends POutput, InputT extends PInput> OutputT apply(PTransform<InputT, OutputT> transform, InputT input) {
        if (transform instanceof Combine.GroupedValues) {
            ...
            return (OutputT) ((PCollection) input).apply(new GroupByKeyViaGroupByKeyOnly((GroupByKey) transform));
        } else {
    ...
    public static <K, V> void evaluateGroupByKeyOnly(GroupByKeyOnly<K, V> transform, EvaluationContext context) {
    ...
    public static <K, V> void registerGroupByKeyOnly() {
        registerDefaultTransformEvaluator(GroupByKeyOnly.class, new TransformEvaluator<GroupByKeyOnly>() {

            @Override
            public void evaluate(GroupByKeyOnly transform, EvaluationContext context) {
