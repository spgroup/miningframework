...
public class JobInfoController {
    ...
    @RequestMapping("/add")
    @ResponseBody
    public ReturnT<String> add(String jobGroup, String jobName, String jobCron, String jobDesc, String jobClass, String handler_params, String handler_address, String handler_name, String author, String alarmEmail, int alarmThreshold) {
    ...
    @ResponseBody
    public ReturnT<String> reschedule(String jobGroup, String jobName, String jobCron, String jobDesc, String jobClass, String handler_params, String handler_address, String handler_name, String author, String alarmEmail, int alarmThreshold) {
        if (JobGroupEnum.match(jobGroup) == null) {
            return new ReturnT<String>(500, "请选择“任务组�?");
        }
        if (StringUtils.isBlank(jobName)) {
