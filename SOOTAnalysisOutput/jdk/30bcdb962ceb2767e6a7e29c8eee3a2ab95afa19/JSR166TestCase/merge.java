...
public class JSR166TestCase extends TestCase {
    ...
    public static Test suite() {
        ...
        if (atLeastJava8()) {
            String[] java8TestClassNames = { "ArrayDeque8Test", "Atomic8Test", "CompletableFutureTest", "ConcurrentHashMap8Test", "CountedCompleter8Test", "DoubleAccumulatorTest", "DoubleAdderTest", "ForkJoinPool8Test", "ForkJoinTask8Test", "LongAccumulatorTest", "LongAdderTest", "SplittableRandomTest", "StampedLockTest", "SubmissionPublisherTest", "ThreadLocalRandom8Test", "TimeUnit8Test" };
            addNamedTestClasses(suite, java8TestClassNames);
        }
        if (atLeastJava9()) {
            String[] java9TestClassNames = { "AtomicBoolean9Test", "AtomicInteger9Test", "AtomicIntegerArray9Test", "AtomicLong9Test", "AtomicLongArray9Test", "AtomicReference9Test", "AtomicReferenceArray9Test", "ExecutorCompletionService9Test" };
