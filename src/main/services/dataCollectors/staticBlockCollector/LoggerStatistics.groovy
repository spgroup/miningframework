...
class LoggerStatistics {
   ...
   public static long timeFinal;
    ...
    static synchronized void updateSpreadsheet(Project project, MergeCommit mergeCommit,Path fileName, String approach, String timeStamp){
        ...
        String newLine = "${project.getName()},${mergeCommit.getSHA()},${fileName.toAbsolutePath().toString()},${approach},${timeStamp}"
