...
public final class SunGraphics2D extends Graphics2D implements ConstrainableGraphics, Cloneable, DestSurfaceProvider {
    ...
    public AffineTransform getTransform() {
        ...
        AffineTransform tx = new AffineTransform(invScale, 0, 0, invScale, -constrainX * invScale, -constrainY * invScale);
    ...
    private boolean drawHiDPIImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2, Color bgcolor, ImageObserver observer) {
