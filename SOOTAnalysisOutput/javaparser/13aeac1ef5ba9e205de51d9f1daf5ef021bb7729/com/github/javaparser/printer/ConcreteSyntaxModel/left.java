...
public class ConcreteSyntaxModel {
    ...
    static {
        ...
        concreteSyntaxModelByClass.put(BreakStmt.class, sequence(comment(), token(GeneratedJavaParserConstants.BREAK), conditional(VALUE, IS_PRESENT, sequence(space(), child(VALUE))), semicolon()));
