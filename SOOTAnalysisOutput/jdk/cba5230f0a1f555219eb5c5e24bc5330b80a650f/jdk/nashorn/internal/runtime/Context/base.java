...
public final class Context {
    ...
    private synchronized Class<?> getAnonymousHostClass(final CodeSource codeSource) {
        ...
        final Class<?> newHostClass = createNewLoader().installClass(AnonymousContextCodeInstaller.ANONYMOUS_HOST_CLASS_NAME, AnonymousContextCodeInstaller.ANONYMOUS_HOST_CLASS_BYTES, codeSource);
