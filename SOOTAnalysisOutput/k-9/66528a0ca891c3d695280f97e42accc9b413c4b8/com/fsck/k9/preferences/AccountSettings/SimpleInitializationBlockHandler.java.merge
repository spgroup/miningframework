...
public class AccountSettings {
    ...
    static {
        ...
        s.put("folderDisplayMode", Settings.versions(new V(1, new EnumSetting(FolderMode.class, FolderMode.NOT_SECOND_CLASS))));
        ...
        s.put("folderTargetMode", Settings.versions(new V(1, new EnumSetting(FolderMode.class, FolderMode.NOT_SECOND_CLASS))));
        ...
        s.put("messageFormat", Settings.versions(new V(1, new EnumSetting(Account.MessageFormat.class, Account.DEFAULT_MESSAGE_FORMAT))));
        ...
        s.put("quoteStyle", Settings.versions(new V(1, new EnumSetting(Account.QuoteStyle.class, Account.DEFAULT_QUOTE_STYLE))));
        ...
        s.put("searchableFolders", Settings.versions(new V(1, new EnumSetting(Account.Searchable.class, Account.Searchable.ALL))));
        s.put("sentFolderName", Settings.versions(new V(1, new StringSetting("Sent"))));
        s.put("sortTypeEnum", Settings.versions(new V(1, new EnumSetting(SORT_TYPE.class, Account.DEFAULT_SORT_TYPE))));
        s.put("sortAscending", Settings.versions(new V(1, new BooleanSetting(Account.DEFAULT_SORT_ASCENDING))));
        s.put("showPicturesEnum", Settings.versions(new V(1, new EnumSetting(Account.ShowPictures.class, Account.ShowPictures.NEVER))));
