...
public class ValueConversions {
    ...
    private static final MethodHandle IDENTITY, CAST_REFERENCE, ZERO_OBJECT, IGNORE, EMPTY, ARRAY_IDENTITY, FILL_NEW_TYPED_ARRAY, FILL_NEW_ARRAY;
    ...
    static MethodHandle collectArguments(MethodHandle mh, int pos, MethodHandle collector) {
        if (COLLECT_ARGUMENTS != null) {
            try {
                return (MethodHandle) COLLECT_ARGUMENTS.invokeExact(mh, pos, collector);
            } catch (Throwable ex) {
    ...
    static {
        ...
        try {
            final java.lang.reflect.Method m = MethodHandles.class.getDeclaredMethod("collectArguments", MethodHandle.class, int.class, MethodHandle.class);
            AccessController.doPrivileged(new PrivilegedAction<Void>() {
    ...
    static {
        MethodHandle mh = null;
        try {
            java.lang.reflect.Method m = MethodHandles.class.getDeclaredMethod("collectArguments", MethodHandle.class, int.class, MethodHandle.class);
            m.setAccessible(true);
            mh = IMPL_LOOKUP.unreflect(m);
    ...
    private static final EnumMap<Wrapper, MethodHandle>[] CONVERT_PRIMITIVE_FUNCTIONS = newWrapperCaches(Wrapper.values().length);
    ...
    public static MethodHandle convertPrimitive(Wrapper wsrc, Wrapper wdst) {
        ...
        if (wsrc == wdst) {
            ...
            mh = MethodHandles.dropArguments(EMPTY, 0, src);
    ...
    private static MethodHandle buildFiller(int nargs) {
        ...
        MethodHandle rightFill = FILL_ARRAYS[rightLen].bindTo(midLen);
