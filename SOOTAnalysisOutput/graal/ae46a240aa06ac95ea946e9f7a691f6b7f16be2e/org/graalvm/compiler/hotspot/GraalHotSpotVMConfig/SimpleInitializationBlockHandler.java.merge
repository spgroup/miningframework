...
public class GraalHotSpotVMConfig extends GraalHotSpotVMConfigAccess {
    ...
    public final int javaThreadReservedStackActivationOffset = JDK <= 15 ? getFieldOffset("JavaThread::_reserved_stack_activation", Integer.class, "address") : getFieldOffset("JavaThread::_stack_overflow_state._reserved_stack_activation", Integer.class, "address");
