...
class BeanLinker extends AbstractJavaLinker implements TypeBasedGuardingDynamicLinker {
    ...
    private static GuardedInvocationComponent guardComponentWithRangeCheck(final GuardedInvocationComponentAndCollectionType gicact, final MethodType callSiteType, final GuardedInvocationComponent nextComponent, final Binder binder, final MethodHandle noOp) {
    ...
    private static class Binder {
        ...
        MethodHandle convertArgToNumber(final MethodHandle mh) {
    ...
    private static final MethodHandle REMOVE_LIST_ELEMENT = Lookup.PUBLIC.findVirtual(List.class, "remove", MethodType.methodType(Object.class, int.class));

    private static final MethodHandle REMOVE_MAP_ELEMENT = Lookup.PUBLIC.findVirtual(Map.class, "remove", MethodType.methodType(Object.class, Object.class));
    ...
    private GuardedInvocationComponent getElementRemover(final ComponentLinkRequest req) throws Exception {
        ...
        final MethodType callSiteType = callSiteDescriptor.getMethodType();
        final GuardedInvocationComponent nextComponent = getNextComponent(req);
        final GuardedInvocationComponentAndCollectionType gicact = guardedInvocationComponentAndCollectionType(callSiteType, linkerServices, null, REMOVE_LIST_ELEMENT, REMOVE_MAP_ELEMENT);
        if (gicact == null) {
            return nextComponent;
        }
        final Object typedName = getTypedName(name, gicact.collectionType == CollectionType.MAP, linkerServices);
        ...
        return guardComponentWithRangeCheck(gicact, callSiteType, nextComponent, new Binder(linkerServices, callSiteType, typedName), isFixedKey ? NO_OP_1 : NO_OP_2);
    }
