...
public static _Fields findByThriftId(int fieldId) {
    ...
    public TabletStats(org.apache.accumulo.core.dataImpl.thrift.TKeyExtent extent, ActionStats majors, ActionStats minors, ActionStats splits, long numEntries, double ingestRate, double queryRate, long splitCreationTime) {
        this();
        this.extent = extent;
        this.majors = majors;
        this.minors = minors;
