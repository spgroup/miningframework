...
public class Base {
    ...
    private void buildCoreModes() {
        ...
        Mode androidMode = ModeContribution.load(this, getContentFile("modes/android"), "processing.mode.android.AndroidMode").getMode();
        Mode javaScriptMode = ModeContribution.load(this, getContentFile("modes/javascript"), "processing.mode.javascript.JavaScriptMode").getMode();
        ...
        if (editors.size() == 1) {
            if (Base.isMacOS()) {
                if (defaultFileMenu == null) {
                    ...
                    String prompt = "<html> " + "<head> <style type=\"text/css\">" + "b { font: 13pt \"Lucida Grande\" }" + "p { font: 11pt \"Lucida Grande\"; margin-top: 8px }" + "</style> </head>" + "<b>Are you sure you want to Quit?</b>" + "<p>Closing the last open sketch will quit Processing.";
    ...
    static public void showWarningTiered(String title, String primary, String secondary, Exception e) {
        ...
        if (commandLine) {
            ...
            if (!Base.isMacOS()) {
                ...
                JOptionPane pane = new JOptionPane("<html> " + "<head> <style type=\"text/css\">" + "b { font: 13pt \"Lucida Grande\" }" + "p { font: 11pt \"Lucida Grande\"; margin-top: 8px }" + "</style> </head>" + "<b>" + primary + "</b>" + "<p>" + secondary + "</p>", JOptionPane.WARNING_MESSAGE);
    ...
    static public int showYesNoQuestion(Frame editor, String title, String primary, String secondary) {
        if (!Base.isMacOS()) {
            ...
            JOptionPane pane = new JOptionPane("<html> " + "<head> <style type=\"text/css\">" + "b { font: 13pt \"Lucida Grande\" }" + "p { font: 11pt \"Lucida Grande\"; margin-top: 8px }" + "</style> </head>" + "<b>" + primary + "</b>" + "<p>" + secondary + "</p>", JOptionPane.QUESTION_MESSAGE);
