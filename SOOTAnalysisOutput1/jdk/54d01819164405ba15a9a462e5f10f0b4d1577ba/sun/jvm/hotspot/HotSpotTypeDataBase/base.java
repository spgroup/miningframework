        ...
        if (fieldType == null) {
            if (cTypeName.startsWith("GrowableArray<") && cTypeName.endsWith(">")) {
                ...
                while (fields.hasNext()) {
                    ...
                    basicTargetType.addField(internalCreateField(basicTargetType, f.getName(), f.getType(), f.isStatic(), f.getOffset(), null));
                }
            ...
            try {
                ...
                while (t.nextToken() != StreamTokenizer.TT_EOF) {
                    ...
                    if (t.sval.equals("field")) {
                        ...
                        if (!defined) {
                            createField(containingType, fieldName, fieldType, isStatic, offset, staticAddress);
                        }
