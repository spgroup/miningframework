...
public class ModelConfigurableSides extends BakedIEModel {
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        if (extraData.hasProperty(Model.SIDECONFIG))
            ...
            for (Direction d : Direction.VALUES) config.put(d, IOSideConfig.NONE);
        }
        assert (config != null);
        ...
        try {
            ...
            return modelCache.get(key, () -> {
                ...
                for (Direction d : Direction.VALUES) tex.put(d, this.textures.get(d).get(config.get(d)));
    ...
    public IModelData getModelData(@Nonnull ILightReader world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData) {
        ...
        if (te instanceof IConfigurableSides) {
            ...
            for (Direction d : VALUES) conf.put(d, confTE.getSideConfig(d));
    ...
    static final ItemCameraTransforms defaultTransforms = new ItemCameraTransforms(new ItemTransformVec3f(new Vector3f(75, 45, 0), new Vector3f(0, .25f, 0), new Vector3f(0.375f, 0.375f, 0.375f)), new ItemTransformVec3f(new Vector3f(75, 45, 0), new Vector3f(0, .15625f, 0), new Vector3f(0.375f, 0.375f, 0.375f)), new ItemTransformVec3f(new Vector3f(0, 45, 0), new Vector3f(0, 0, 0), new Vector3f(.4f, .4f, .4f)), new ItemTransformVec3f(new Vector3f(0, 225, 0), new Vector3f(0, 0, 0), new Vector3f(.4f, .4f, .4f)), new ItemTransformVec3f(new Vector3f(0, 0, 0), new Vector3f(0, 0, 0), new Vector3f(1, 1, 1)), new ItemTransformVec3f(new Vector3f(30, 225, 0), new Vector3f(0, 0, 0), new Vector3f(.625f, .625f, .625f)), new ItemTransformVec3f(new Vector3f(0, 0, 0), new Vector3f(0, .1875f, 0), new Vector3f(.25f, .25f, .25f)), new ItemTransformVec3f(new Vector3f(0, 0, 0), new Vector3f(0, 0, 0), new Vector3f(.5f, .5f, .5f)));
    ...
    public static class Loader implements IModelLoader<ConfigSidesModelBase> {
        ...
        public ConfigSidesModelBase read(@Nonnull JsonDeserializationContext deserializationContext, JsonObject modelContents) {
            ...
            for (Direction f : Direction.VALUES) for (IOSideConfig cfg : IOSideConfig.values()) {
    ...
    private static class ModelKey {
        ...
        public boolean equals(Object o) {
            ...
            return name.equals(modelKey.name) && config.equals(modelKey.config);
        }
