...
public class ExecuteInstalledCodeTest {
    ...
    private void checkSanity(CompileCodeTestCase testCase) {
        ...
        InstalledCode installedCode = new InstalledCode(testCase.executable.getName());
    ...
    private Object getReciever(CompileCodeTestCase testCase) {
        return CompileCodeTestCase.RECEIVERS.get(testCase.executable.getDeclaringClass());
    }

    public Pair<Object, ? extends Throwable> invoke(CompileCodeTestCase testCase, Object[] args) {
