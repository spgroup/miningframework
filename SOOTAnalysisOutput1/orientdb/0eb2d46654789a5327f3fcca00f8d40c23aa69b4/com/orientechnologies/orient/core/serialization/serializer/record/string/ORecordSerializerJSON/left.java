...
public class ORecordSerializerJSON extends ORecordSerializerStringAbstract {
    ...
    public ORecordInternal<?> fromString(String iSource, ORecordInternal<?> iRecord, final String[] iFields, final String iOptions, boolean needReload) {
        ...
        if (iOptions != null) {
            ...
            for (String f : format) if (f.equals("noMap"))
                noMap = true;
        }
    ...
    @Override
    public StringBuilder toString(final ORecordInternal<?> iRecord, final StringBuilder iOutput, final String iFormat, final OUserObject2RecordHandler iObjHandler, final Set<Long> iMarshalledRecords, boolean iOnlyDelta, boolean autoDetectCollectionType) {
        try {
