...
public class DataflowRunner extends PipelineRunner<DataflowPipelineJob> {
    ...
    public static DataflowRunner fromOptions(PipelineOptions options) {
        ...
        String agentJavaVer = (Environments.getJavaVersion() == Environments.JavaVersion.java8) ? "(JRE 8 environment)" : "(JDK 11 environment)";
    ...
    static boolean useUnifiedWorker(DataflowPipelineOptions options) {
        return hasExperiment(options, "beam_fn_api") || hasExperiment(options, "use_runner_v2") || hasExperiment(options, "use_unified_worker") || (hasExperiment(options, "enable_prime") && !hasExperiment(options, "disable_prime_runner_v2"));
    }
