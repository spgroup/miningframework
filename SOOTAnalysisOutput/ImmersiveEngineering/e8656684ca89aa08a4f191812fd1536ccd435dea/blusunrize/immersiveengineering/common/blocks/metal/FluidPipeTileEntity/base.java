...
public class FluidPipeTileEntity extends IEBaseTileEntity implements IFluidPipe, IAdvancedHasObjProperty, IOBJModelCallback<BlockState>, IColouredTile, IPlayerInteraction, IHammerInteraction, IPlacementInteraction, ISelectionBounds, ICollisionBounds, IAdditionalDrops, INeighbourChangeTile {
    ...
    public static IEObjState getStateFromKey(String key) {
        if (!cachedOBJStates.containsKey(key)) {
            ...
            Matrix4 rotationMatrix = new Matrix4(TRSRTransformation.identity().getMatrixVec());
            ...
            cachedOBJStates.put(key, new IEObjState(VisibilityList.show(parts), new TRSRTransformation(rotationMatrix.toMatrix4f())));
        }
