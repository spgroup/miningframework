...
public class ReferenceObjects {
    ...
    public static boolean isEqual(NearCacheConfigHolder a, NearCacheConfigHolder that) {
        ...
        return a.getPreloaderConfig() != null ? isEqual(a.getPreloaderConfig(), that.getPreloaderConfig()) : that.getPreloaderConfig() == null;
    }
    ...
    public static boolean isEqual(EvictionConfigHolder a, EvictionConfigHolder b) {
        ...
        if (a.getComparatorClassName() != null ? !a.getComparatorClassName().equals(b.getComparatorClassName()) : b.getComparatorClassName() != null) {
            return false;
        }
        return a.getComparator() != null ? a.getComparator().equals(b.getComparator()) : b.getComparator() == null;
    }
    ...
    public static boolean isEqual(ListenerConfigHolder a, ListenerConfigHolder b) {
        ...
        return a.getListenerImplementation() != null ? a.getListenerImplementation().equals(b.getListenerImplementation()) : b.getListenerImplementation() == null;
    }
    ...
    public static boolean isEqual(MapIndexConfig a, MapIndexConfig that) {
        ...
        return a.getAttribute() != null ? a.getAttribute().equals(that.getAttribute()) : that.getAttribute() == null;
    }
    ...
    public static boolean isEqual(MapAttributeConfig a, MapAttributeConfig that) {
        ...
        return a.getExtractor() != null ? a.getExtractor().equals(that.getExtractor()) : that.getExtractor() == null;
    }
    ...
    public static boolean isEqual(MapStoreConfigHolder a, MapStoreConfigHolder b) {
        ...
        if (a.getFactoryImplementation() != null ? !a.getFactoryImplementation().equals(b.getFactoryImplementation()) : b.getFactoryImplementation() != null) {
            return false;
        }
        if (a.getProperties() != null ? !a.getProperties().equals(b.getProperties()) : b.getProperties() != null) {
            return false;
        }
        return a.getInitialLoadMode() != null ? a.getInitialLoadMode().equals(b.getInitialLoadMode()) : b.getInitialLoadMode() == null;
    }
    ...
    public static boolean isEqual(QueryCacheConfigHolder a, QueryCacheConfigHolder b) {
        ...
        if (a.getListenerConfigs() != null ? !isEqual(a.getListenerConfigs(), b.getListenerConfigs()) : b.getListenerConfigs() != null) {
            return false;
        }
        return a.getIndexConfigs() != null ? isEqual(a.getIndexConfigs(), b.getIndexConfigs()) : b.getIndexConfigs() == null;
    }
    ...
    public static boolean isEqual(PredicateConfigHolder a, PredicateConfigHolder b) {
        ...
        return a.getImplementation() != null ? a.getImplementation().equals(b.getImplementation()) : b.getImplementation() == null;
    }
    ...
    public static Map.Entry<String, byte[]> aStringToByteArrEntry = new AbstractMap.SimpleEntry<String, byte[]>(aString, new byte[] { aByte });

    public static List<Map.Entry<String, byte[]>> aListOfStringToByteArrEntry = Arrays.asList(aStringToByteArrEntry, aStringToByteArrEntry);
    ...
    public static List<Map.Entry<String, Long>> aListOfStringToLong = Collections.<Map.Entry<String, Long>>singletonList(new AbstractMap.SimpleEntry<String, Long>("test", 3141592L));

    public static List<Map.Entry<String, String>> aListOfStringToString = Collections.<Map.Entry<String, String>>singletonList(new AbstractMap.SimpleEntry<String, String>("test", "testValue"));

    static {
        List<Map.Entry<Integer, Long>> list = Collections.<Map.Entry<Integer, Long>>singletonList(new AbstractMap.SimpleEntry<Integer, Long>(anInt, aLong));
        aNamePartitionSequenceList = Collections.<Map.Entry<String, List<Map.Entry<Integer, Long>>>>singletonList(new AbstractMap.SimpleEntry<String, List<Map.Entry<Integer, Long>>>(aString, list));
    }

    public static List<Map.Entry<Integer, UUID>> aPartitionUuidList = Collections.<Map.Entry<Integer, UUID>>singletonList(new AbstractMap.SimpleEntry<Integer, UUID>(anInt, aUUID));
    ...
    public static final SerializationService serializationService = defaultSerializationServiceBuilder.setVersion(InternalSerializationService.VERSION_1).build();
    ...
    static {
        ...
        SerializationService serializationService = defaultSerializationServiceBuilder.setVersion(InternalSerializationService.VERSION_1).build();
        ...
        ListenerConfigHolder holder2 = new ListenerConfigHolder(TYPE_CACHE_PARTITION_LOST_LISTENER_CONFIG, (Data) serializationService.toData(new TestCachePartitionLostEventListener()), true, false);
        ...
        props.setProperty("a", "b");
        ringbufferStore = new RingbufferStoreConfigHolder("com.hazelcast.RingbufferStore", null, null, null, props, true);
        queueStoreConfig = new QueueStoreConfigHolder("com.hazelcast.QueueStore", null, null, null, props, true);
        wanReplicationRef = new WanReplicationRef("wan-target", "com.hazelcast.MergePolicy", Collections.singletonList("com.hazelcast.WanFilter"), true);
        ...
        evictionConfig = new EvictionConfigHolder(100, "ENTRY_COUNT", "LRU", "com.hazelcast.ComparatorClassName", serializationService.toData(comparatorImpl));
        nearCachePreloaderConfig = new NearCachePreloaderConfig(true, "/root/");
        nearCacheConfig = new NearCacheConfigHolder("nearCache", "BINARY", false, true, 139, 156, evictionConfig, false, "INVALIDATE", nearCachePreloaderConfig);
        ...
        queryCacheConfig.setPredicateConfigHolder(new PredicateConfigHolder("com.hazelcast.Predicate", "name LIKE 'Fred%'", serializationService.toData(new TruePredicate())));
        ...
        timedExpiryPolicyFactoryConfig = new TimedExpiryPolicyFactoryConfig(ExpiryPolicyType.CREATED, new DurationConfig(30, TimeUnit.SECONDS));
    ...
    public static class TestCachePartitionLostEventListener implements CachePartitionLostListener, Serializable {
