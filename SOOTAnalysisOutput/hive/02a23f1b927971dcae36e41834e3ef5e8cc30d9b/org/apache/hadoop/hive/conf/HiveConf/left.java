...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        HIVE_AUTHORIZATION_HDFS_LIST_STATUS_BATCH_SIZE("hive.authprovider.hdfs.liststatus.batch.size", 1000, "Number of FileStatus objects to be queried for when listing files, for HDFS-based authorization.\n" + "Note: If this exceeds dfs.ls.limit (as set in hdfs-site.xml), DFSClient might use the smaller value as \n" + "the batch-size, internally."),
