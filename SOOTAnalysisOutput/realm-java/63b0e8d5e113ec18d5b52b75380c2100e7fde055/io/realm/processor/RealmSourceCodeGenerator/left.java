...
public class RealmSourceCodeGenerator {
    ...
    static {
        ...
        HASHCODE.put("boolean", new String[] { "result = 31 * result + (get%s() ? 1 : 0)" });
        HASHCODE.put("Byte", new String[] { "result = 31 * result + (int) get%s()" });
        HASHCODE.put("Short", new String[] { "result = 31 * result + (int) get%s()" });
    ...
    public void generate() throws IOException, UnsupportedOperationException {
        ...
        writer.emitStatement(className + " a" + className + " = (" + className + ")o");
        writer.emitStatement("return (hashCode() == a" + className + ".hashCode())");
        writer.endMethod();
        writer.emitEmptyLine();
        writer.endType();
        writer.close();
