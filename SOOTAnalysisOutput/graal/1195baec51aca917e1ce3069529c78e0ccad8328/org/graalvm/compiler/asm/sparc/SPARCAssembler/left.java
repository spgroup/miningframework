...
public abstract class SPARCAssembler extends Assembler {
    ...
    public enum OpfLow {
        ...
        Fmovscc(0b00_0001, "fmovscc", Fpop2), Fmovdcc(0b00_0010, "fmovdcc", Fpop2);
    ...
    public enum BranchPredict {
        ...
        PREDICT_TAKEN(1), PREDICT_NOT_TAKEN(0);
    ...
    public static final class OpfOp extends SPARCOp {
        ...
        public OpfOp() {
            this(new BitKey[] { new BitKey(BitSpec.op3, Op3s.Fpop1.value), new BitKey(BitSpec.op3, Op3s.Fpop2.value), new BitKey(BitSpec.op3, Op3s.Impdep1.value), new BitKey(BitSpec.op3, Op3s.Impdep2.value) });
        }
