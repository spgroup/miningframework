...
public class DefaultSdkProvider implements SdkProvider {
    ...
    static final Map<Integer, SdkVersion> SUPPORTED_APIS = Collections.unmodifiableMap(new HashMap<Integer, SdkVersion>() {
        ...
        private void addSdk(int sdkVersion, String androidVersion, String frameworkSdkBuildVersion, String codeName) {
    ...
    private static SdkConfig staticGetSdkConfig(int apiLevel) {
        ...
        return new SdkConfig(apiLevel, sdkVersion.androidVersion, sdkVersion.robolectricVersion, sdkVersion.codeName);
    }
