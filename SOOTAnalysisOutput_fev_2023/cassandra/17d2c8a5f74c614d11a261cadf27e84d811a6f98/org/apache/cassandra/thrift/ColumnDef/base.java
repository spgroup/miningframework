...
public class ColumnDef implements TBase<ColumnDef, ColumnDef._Fields>, java.io.Serializable, Cloneable {
    ...
    public enum _Fields implements TFieldIdEnum {
        ...
        NAME((short) 1, "name"), VALIDATION_CLASS((short) 2, "validation_class"), INDEX_TYPE((short) 3, "index_type"), INDEX_NAME((short) 4, "index_name");
    ...
    static {
        ...
        tmpMap.put(_Fields.VALIDATION_CLASS, new FieldMetaData("validation_class", TFieldRequirementType.REQUIRED, new FieldValueMetaData(TType.STRING)));
        tmpMap.put(_Fields.INDEX_TYPE, new FieldMetaData("index_type", TFieldRequirementType.OPTIONAL, new EnumMetaData(TType.ENUM, IndexType.class)));
        tmpMap.put(_Fields.INDEX_NAME, new FieldMetaData("index_name", TFieldRequirementType.OPTIONAL, new FieldValueMetaData(TType.STRING)));
