...
public class UpdateErrors implements org.apache.thrift.TBase<UpdateErrors, UpdateErrors._Fields>, java.io.Serializable, Cloneable, Comparable<UpdateErrors> {
    ...
    public Map<TKeyExtent, org.apache.accumulo.core.client.impl.thrift.SecurityErrorCode> authorizationFailures;
    ...
    public UpdateErrors(Map<TKeyExtent, Long> failedExtents, List<TConstraintViolationSummary> violationSummaries, Map<TKeyExtent, org.apache.accumulo.core.client.impl.thrift.SecurityErrorCode> authorizationFailures) {
        this();
