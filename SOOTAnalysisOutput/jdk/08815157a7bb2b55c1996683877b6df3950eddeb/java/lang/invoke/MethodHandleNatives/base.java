...
class MethodHandleNatives {
    ...
    private static MemberName varHandleOperationLinkerMethod(String name, MethodType mtype, Object[] appendixResult) {
        ...
        MethodType guardType = sigType.insertParameterTypes(0, VarHandle.class).appendParameterTypes(VarHandle.AccessDescriptor.class);
        VarHandle.AccessDescriptor ad = new VarHandle.AccessDescriptor(mtype, ak.at.ordinal(), ak.ordinal());
        appendixResult[0] = ad;
        if (MethodHandleStatics.VAR_HANDLE_GUARDS) {
            MemberName linker = new MemberName(VarHandleGuards.class, "guard_" + getVarHandleMethodSignature(sigType), guardType, REF_invokeStatic);
