...
public class cgBase {
    ...
    public final static SimpleDateFormat dateEvIn = new SimpleDateFormat("dd MMMMM yyyy", Locale.ENGLISH);
    ...
    public final static SimpleDateFormat dateGPXIn = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");

    public final static SimpleDateFormat dateLogs1 = new SimpleDateFormat("MMMMM dd, yyyy", Locale.ENGLISH);

    public final static SimpleDateFormat dateLogs2 = new SimpleDateFormat("MMMMM dd", Locale.ENGLISH);
    ...
    public cgCacheWrap parseCache(String page, int reason) {
        ...
        try {
            ...
            while (matcherLog.find()) {
                ...
                try {
                    logDone.date = dateLogs1.parse(matcherLog.group(5)).getTime();
