...
public class cgBase {
    ...
    static {
        final String[] formats = new String[] { "MM/dd/yyyy", "yyyy-MM-dd", "yyyy/MM/dd", "dd/MMM/yyyy", "MMM/dd/yyyy", "dd MMM yy" };
        ...
        try {
            ...
            if (matcherLogCounts.find()) {
                ...
                while (matcherLog.find()) {
                    ...
                    if (typeStr != null && typeStr.length() > 0 && logTypes.containsKey(typeStr.toLowerCase()) && countStr != null && countStr.length() > 0) {
    ...
    private static Date parseGcCustomDate(String input) throws ParseException {
        if (input == null) {
