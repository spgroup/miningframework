...
public class IEFontRender extends FontRenderer {
    ...
    static {
        unicodeReplacements.put((char) Integer.parseInt("260E", 16), new TexturedGlyph(RenderType.getText(new ResourceLocation(ImmersiveEngineering.MODID, "textures/gui/hud_elements.png")), RenderType.getTextSeeThrough(new ResourceLocation(ImmersiveEngineering.MODID, "textures/gui/hud_elements.png")), .5f, .75f, .5625f, .8125f, 0, 7.99F, 0, 7.99F));
    }
