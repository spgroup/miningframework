...
public class MergeConflictCountTest {
    ...
    public void mergeConflictTest () {
        ...
        assertEquals(conflictFilesNumber.get(commitSHA), '1')
        assertEquals(mergeConflictsNumber.get(commitSHA), '1')
    ...
    public void multipleConflict () {
        ...
        assertEquals(conflictFilesNumber.get(commitSHA), '2')
        assertEquals(mergeConflictsNumber.get(commitSHA),'2')
    }
    ...
    public void noMergeConflictTest () {
        ...
        assertEquals(conflictFilesNumber.get(commitSHA), '0')
        assertEquals(mergeConflictsNumber.get(commitSHA), '0')
    }
