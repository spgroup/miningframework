...
public class ProcessDefinitionCollectionResource {
    ...
    public DataResponse getProcessDefinitions(@RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {
        ...
        return new ProcessDefinitionsPaginateList(restResponseFactory, request.getRequestURL().toString().replace("/repository/process-definitions", "")).paginateList(allRequestParams, processDefinitionQuery, "name", properties);
    }
}