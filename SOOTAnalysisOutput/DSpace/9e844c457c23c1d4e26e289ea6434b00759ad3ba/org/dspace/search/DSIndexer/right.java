...
public class DSIndexer {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        options.addOption(OptionBuilder.withArgName("item handle").hasArg(true).withDescription("remove an Item, Collection or Community from index based on its handle").create("r"));
