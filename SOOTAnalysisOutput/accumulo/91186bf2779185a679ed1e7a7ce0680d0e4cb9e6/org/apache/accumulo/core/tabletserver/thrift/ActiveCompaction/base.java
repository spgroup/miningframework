...
public class ActiveCompaction implements org.apache.thrift.TBase<ActiveCompaction, ActiveCompaction._Fields>, java.io.Serializable, Cloneable {
    ...
    public ActiveCompaction(org.apache.accumulo.core.data.thrift.TKeyExtent extent, long age, List<String> inputFiles, String outputFile, CompactionType type, CompactionReason reason, String localityGroup, long entriesRead, long entriesWritten, List<org.apache.accumulo.core.data.thrift.IterInfo> ssiList, Map<String, Map<String, String>> ssio) {
        this();
        this.extent = extent;
        this.age = age;
        setAgeIsSet(true);
