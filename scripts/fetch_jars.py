...
ci_platform = sys.argv[4] # ci platform name

def fetch_jars(input_path, output_path, token, ci_platform):
    ...
    try:
        ...
        for project in projects:
            ...
            try:
                ...
                wait_for_builds(github_project, ci_platform)
...
def wait_for_builds(project, ci_platform):
    if ci_platform == "travis":
        travis.wait_for_builds(project)
    elif ci_platform == "github":
        github_actions.wait_for_builds(project)
...
fetch_jars(input_path, output_path, token, ci_platform)