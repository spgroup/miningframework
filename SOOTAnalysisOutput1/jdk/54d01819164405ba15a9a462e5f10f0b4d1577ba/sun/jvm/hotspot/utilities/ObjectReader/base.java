...
public class ObjectReader {
    ...
    protected Object getHashtable(Instance oop, boolean isProperties) {
        ...
        java.util.Hashtable table = (isProperties) ? new java.util.Properties() : new java.util.Hashtable();
    ...
    protected class FieldSetter extends DefaultOopVisitor {
        ...
        private void printFieldSetError(java.lang.reflect.Field f, Exception ex) {
            if (DEBUG) {
                if (f != null)
                    debugPrintln("Field set failed for " + f);
    ...
    public java.lang.reflect.Method readMethod(sun.jvm.hotspot.oops.Method m) throws NoSuchMethodException, ClassNotFoundException {
    ...
    public java.lang.reflect.Constructor readConstructor(sun.jvm.hotspot.oops.Method m) throws NoSuchMethodException, ClassNotFoundException {
    ...
    public java.lang.reflect.Field readField(sun.jvm.hotspot.oops.Field f) throws NoSuchFieldException, ClassNotFoundException {
