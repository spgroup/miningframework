...
abstract class BandStructure {
...

    {
        ...
        predefineAttribute(METHOD_ATTR_MethodParameters, ATTR_CONTEXT_METHOD, new Band[] { method_MethodParameters_NB, method_MethodParameters_name_RUN, method_MethodParameters_flag_I }, "MethodParameters", "NB[RUNHI]");
