...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        HIVE_EXPLAIN_USER("hive.explain.user", false, "Whether to show explain result at user level.\n" + "When enabled, will log EXPLAIN output for the query at user level."),
        ...
        HIVE_METRICS_JSON_FILE_LOCATION("hive.service.metrics.file.location", "file:///tmp/my-logging.properties", "For metric class org.apache.hadoop.hive.common.metrics.metrics2.CodahaleMetrics JSON_FILE reporter, the location of JSON metrics file.  " + "This file will get overwritten at every interval."),
