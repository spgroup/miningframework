...
public class JenkinsRule implements TestRule, MethodRule, RootAction {
    ...
    public void assertXPath(HtmlPage page, String xpath) {
        ...
        assertNotNull("There should be an object that matches XPath:" + xpath, DomNodeUtil.selectSingleNode(documentElement, xpath));
    }
    ...
    public class WebClient extends com.gargoylesoftware.htmlunit.WebClient {
        ...
        public WebRequest addCrumb(WebRequest req) {
            NameValuePair crumb = new NameValuePair(jenkins.getCrumbIssuer().getDescriptor().getCrumbRequestField(), jenkins.getCrumbIssuer().getCrumb(null));
