...
public class Utils {
    ...
    public static boolean isClassFile(String filename) {
        return endsWithIgnoreCase(filename, CLASSFILE_EXT) && !(filename.substring(filename.lastIndexOf('/') + 1, filename.lastIndexOf('.')).equals("module-info"));
    }
    ...
    public static String classNameToFileName(String classname) {
        return classname.replace('.', '/').concat(CLASSFILE_EXT);
    }
}