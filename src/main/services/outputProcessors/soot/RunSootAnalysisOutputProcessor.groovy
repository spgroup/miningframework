...
class RunSootAnalysisOutputProcessor implements OutputProcessor {
    ...
    RunSootAnalysisOutputProcessor(String dependenciesPath) {
        ...
        this.detectionAlgorithms = [
                ...
                new ConflictDetectionAlgorithm("OA Intra", "overriding-intraprocedural-without-pointeranalisys", this.sootWrapper, TIMEOUT),
                new ConflictDetectionAlgorithm("OA Inter", "overriding-interprocedural-without-pointeranalisys", this.sootWrapper, TIMEOUT, true),
