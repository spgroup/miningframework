...
final class PropMap implements SortedMap<String, String> {
    ...
    static {
        ...
        props.put(Utils.DEBUG_DISABLE_NATIVE, String.valueOf(Boolean.parseBoolean(propValue)));
        int verbose = 0;
        try {
        ...
        props.put(Utils.CLASS_FORMAT_ERROR, getPropertyValue(Utils.CLASS_FORMAT_ERROR, Pack200.Packer.PASS));
