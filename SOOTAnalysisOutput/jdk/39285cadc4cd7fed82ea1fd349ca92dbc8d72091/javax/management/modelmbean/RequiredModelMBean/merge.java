...
public class RequiredModelMBean implements ModelMBean, MBeanRegistration, NotificationEmitter, DynamicWrapperMBean {
    ...
    private static Method resolveMethod(Class<?> targetClass, String opMethodName, String[] sig) throws ReflectionException {
        final boolean tracing = MODELMBEAN_LOGGER.isLoggable(Level.FINER);
        if (tracing) {
            MODELMBEAN_LOGGER.logp(Level.FINER, RequiredModelMBean.class.getName(), "resolveMethod", "resolving " + targetClass + "." + opMethodName);
        }
