...
public class ConditionalUpdates implements org.apache.thrift.TBase<ConditionalUpdates, ConditionalUpdates._Fields>, java.io.Serializable, Cloneable {
    ...
    public ConditionalUpdates(List<Condition> conditions, List<ColumnUpdate> updates) {
        this();
