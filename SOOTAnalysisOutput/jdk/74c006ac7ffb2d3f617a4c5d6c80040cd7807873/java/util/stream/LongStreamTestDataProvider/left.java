    ...
    static {
        {
            ...
            for (Object[] data : arrays) {
                ...
                list.add(new Object[] { "array:" + name, TestData.Factory.ofArray("array:" + name, longs) });
                ...
                list.add(streamDataDescr("LongStream.longRange(0,l): " + longs.length, () -> LongStream.range(0, longs.length)));
                list.add(streamDataDescr("LongStream.longRangeClosed(0,l): " + longs.length, () -> LongStream.rangeClosed(0, longs.length)));
            }
        ...
        }
        {
            ...
            for (Object[] data : arrays) {
                ...
                spliterators.add(splitDescr("Arrays.s(array):" + name, () -> Arrays.spliterator(longs)));
                spliterators.add(splitDescr("Arrays.s(array,o,l):" + name, () -> Arrays.spliterator(longs, 0, longs.length / 2)));
                spliterators.add(splitDescr("SpinedBuffer.s():" + name, () -> isl.spliterator()));
                spliterators.add(splitDescr("Primitives.s(SpinedBuffer.iterator(), size):" + name, () -> Spliterators.spliterator(isl.iterator(), longs.length, 0)));
                spliterators.add(splitDescr("Primitives.s(SpinedBuffer.iterator()):" + name, () -> Spliterators.spliteratorUnknownSize(isl.iterator(), 0)));
                spliterators.add(splitDescr("LongStream.longRange(0,l):" + name, () -> LongStream.range(0, longs.length).spliterator()));
                spliterators.add(splitDescr("LongStream.longRangeClosed(0,l):" + name, () -> LongStream.rangeClosed(0, longs.length).spliterator()));
                spliterators.add(splitDescr("LongStream.iterate(0,x->x<l;x->x+1):" + name, () -> LongStream.iterate(0L, x -> x < longs.length, x -> x + 1L).spliterator()));
            }
