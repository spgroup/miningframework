...
public class Base {
    ...
    static private String VERSION_NAME = "0230";
    ...
    private void buildCoreModes() {
        ...
        ModeContribution experimentalContrib = ModeContribution.load(this, getContentFile("modes/ExperimentalMode"), "processing.mode.experimental.ExperimentalMode");
    ...
    private Mode promptForMode(final File sketch, final ModeInfo preferredMode) {
        ...
        if (possibleModes.size() == 1 && possibleModes.get(0).getIdentifier().equals(JavaMode.class.getCanonicalName())) {
    ...
    static public int showYesNoCancelQuestion(Editor editor, String title, String primary, String secondary) {
        if (!Base.isMacOS()) {
            ...
            JOptionPane pane = new JOptionPane("<html> " + "<head> <style type=\"text/css\">" + "b { font: 13pt \"Lucida Grande\" }" + "p { font: 11pt \"Lucida Grande\"; margin-top: 8px; width: 300px }" + "</style> </head>" + "<b>Do you want to save changes to this sketch<BR>" + " before closing?</b>" + "<p>If you don't save, your changes will be lost.", JOptionPane.QUESTION_MESSAGE);
    ...
    static public void copyDirNative(File sourceDir, File targetDir) throws IOException {
