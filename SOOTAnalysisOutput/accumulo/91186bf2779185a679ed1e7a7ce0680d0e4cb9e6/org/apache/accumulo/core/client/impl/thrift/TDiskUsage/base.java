...
public class TDiskUsage implements org.apache.thrift.TBase<TDiskUsage, TDiskUsage._Fields>, java.io.Serializable, Cloneable {
    ...
    public TDiskUsage(List<String> tables, long usage) {
        this();
        this.tables = tables;
        this.usage = usage;
        setUsageIsSet(true);
