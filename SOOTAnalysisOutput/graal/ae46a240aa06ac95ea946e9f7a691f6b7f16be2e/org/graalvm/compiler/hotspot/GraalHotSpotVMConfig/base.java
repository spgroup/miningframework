...
public class GraalHotSpotVMConfig extends GraalHotSpotVMConfigAccess {
    ...
    private final String markWord = JDK < 14 ? "markOop" : "markWord";
    ...
    public final boolean useCRC32CIntrinsics = getFlag("UseCRC32CIntrinsics", Boolean.class, false, JDK >= 9);
    ...
    public final boolean useCMSGC = getFlag("UseConcMarkSweepGC", Boolean.class, false, JDK < 14);
    ...
    public final int jvmAccIsHiddenClass = getConstant("JVM_ACC_IS_HIDDEN_CLASS", Integer.class, 0, JDK >= 15);
    ...
    public final int javaThreadReservedStackActivationOffset = JDK <= 8 ? 0 : JDK <= 15 ? getFieldOffset("JavaThread::_reserved_stack_activation", Integer.class, "address") : getFieldOffset("JavaThread::_stack_overflow_state._reserved_stack_activation", Integer.class, "address");
...

    {
        if (JDK < 15) {
            ...
            threadPollingPageOffset = getFieldOffset(name, Integer.class, "SafepointMechanism::ThreadData") + getFieldOffset("SafepointMechanism::ThreadData::_polling_page", Integer.class, "volatile uintptr_t");
        }
    }
    ...
    public final long deoptBlobUnpackWithExceptionInTLS = getFieldValue("CompilerToVM::Data::SharedRuntime_deopt_blob_unpack_with_exception_in_tls", Long.class, "address", 0L, JVMCI ? jvmciGE(JVMCI_19_3_b07) : JDK >= 14);
    ...
    public final long invokeJavaMethodAddress = getAddress("JVMCIRuntime::invoke_static_method_one_arg", 0L, JVMCI ? jvmciGE(JVMCI_21_1_b02) : (JDK >= 17 || (IS_OPENJDK && JDK == 11 && JDK_UPDATE >= 13)));
    ...
    public final boolean deoptimizationSupportLargeAccessByteArrayVirtualization = getConstant("Deoptimization::_support_large_access_byte_array_virtualization", Boolean.class, false, JVMCI || JDK >= 15);
    ...
    public final boolean CPU_HAS_INTEL_JCC_ERRATUM = getFieldValue("VM_Version::_has_intel_jcc_erratum", Boolean.class, "bool", true, "amd64".equals(osArch) && (JVMCI ? jvmciGE(JVMCI_20_1_b01) : JDK >= 15));
    ...
    public boolean isMethodHandleCall(HotSpotResolvedJavaMethod targetMethod) {
        ...
        return ((intrinsicId >= VMINTRINSIC_FIRST_MH_SIG_POLY && intrinsicId <= VMINTRINSIC_LAST_MH_SIG_POLY) && intrinsicId != VMINTRINSIC_INVOKE_GENERIC) || intrinsicId == VMINTRINSIC_COMPILED_LAMBDA_FORM;
    }

    public boolean supportsMethodHandleDeoptimizationEntry() {
        return HotSpotMarkId.DEOPT_MH_HANDLER_ENTRY.isAvailable() && VMINTRINSIC_FIRST_MH_SIG_POLY != -1 && VMINTRINSIC_LAST_MH_SIG_POLY != -1 && VMINTRINSIC_INVOKE_GENERIC != -1 && VMINTRINSIC_COMPILED_LAMBDA_FORM != -1;
    }
}
