...
class LoggersEndpointDocumentationTests extends MockMvcEndpointDocumentationTests {
    ...
    static {
        groupLevelFields = Arrays.asList(fieldWithPath("configuredLevel").description("Configured level of the logger group, if any.").type(JsonFieldType.STRING).optional(), fieldWithPath("members").description("Loggers that are part of this group"));
    }
