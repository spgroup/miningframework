...
public final class ComparatorType {
    ...
    public static final ComparatorType DOUBLETYPE = new ComparatorType("org.apache.cassandra.db.marshal.DoubleType");

    private static final Map<String, ComparatorType> valuesMap;

    static {
<<<<<<< MINE
        ComparatorType[] types = { ASCIITYPE, BYTESTYPE, INTEGERTYPE, LEXICALUUIDTYPE, LOCALBYPARTITIONERTYPE, LONGTYPE, TIMEUUIDTYPE, UTF8TYPE, COMPOSITETYPE, DYNAMICCOMPOSITETYPE, UUIDTYPE, COUNTERTYPE, DOUBLETYPE, FLOATTYPE };
=======
        ComparatorType[] types = { ASCIITYPE, BOOLEANTYPE, BYTESTYPE, DECIMALTYPE, FLOATTYPE, INTEGERTYPE, LEXICALUUIDTYPE, LOCALBYPARTITIONERTYPE, LONGTYPE, TIMEUUIDTYPE, UTF8TYPE, COMPOSITETYPE, DYNAMICCOMPOSITETYPE, UUIDTYPE, COUNTERTYPE };
>>>>>>> YOURS
        ImmutableMap.Builder<String, ComparatorType> builder = new ImmutableMap.Builder<String, ComparatorType>();
