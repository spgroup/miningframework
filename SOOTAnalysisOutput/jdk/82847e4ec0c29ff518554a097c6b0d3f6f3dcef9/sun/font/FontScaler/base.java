...
public abstract class FontScaler implements DisposerRecord {
    ...
    static {
        ...
        try {
            ...
            Class<? extends FontScaler> tmp = (Class<? extends FontScaler>) (FontUtilities.isOpenJDK ? Class.forName("sun.font.FreetypeFontScaler") : Class.forName("sun.font.T2KFontScaler"));
            scalerClass = tmp;
