...
public class RestartStressIT extends AccumuloClusterIT {
    ...
    public void test() throws Exception {
        ...
        if (token instanceof PasswordToken) {
            ...
            args = new String[] { "-u", getAdminPrincipal(), "-p", new String(password, Charsets.UTF_8), "-i", cluster.getInstanceName(), "-z", cluster.getZooKeepers(), "--rows", "" + VOPTS.rows, "--table", tableName };
