...
public class UpdateErrors implements org.apache.thrift.TBase<UpdateErrors, UpdateErrors._Fields>, java.io.Serializable, Cloneable {
    ...
    public Map<TKeyExtent, org.apache.accumulo.core.security.thrift.SecurityErrorCode> authorizationFailures;
    ...
    public UpdateErrors(Map<TKeyExtent, Long> failedExtents, List<TConstraintViolationSummary> violationSummaries, Map<TKeyExtent, org.apache.accumulo.core.security.thrift.SecurityErrorCode> authorizationFailures) {
        this();
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                            {
                                ...
                                for (int _i58 = 0; _i58 < _map57.size; ++_i58) {
                                    TKeyExtent _key59;
                                    org.apache.accumulo.core.security.thrift.SecurityErrorCode _val60;
