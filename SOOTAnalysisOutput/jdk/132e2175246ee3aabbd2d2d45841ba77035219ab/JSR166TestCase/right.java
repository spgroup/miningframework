...
public class JSR166TestCase extends TestCase {
    ...
    private static final float delayFactor = systemPropertyValue("jsr166.delay.factor", 1.0f);

    private static final float jtregTestTimeoutFactor = systemPropertyValue("test.timeout.factor", 1.0f);
    ...
    static void dumpTestThreads() {
        ...
        for (ThreadInfo info : threadMXBean.dumpAllThreads(true, true)) {
            ...
            if ("Signal Dispatcher".equals(name))
                continue;
            if ("Reference Handler".equals(name) && info.getLockName().startsWith("java.lang.ref.Reference$Lock"))
                continue;
            if ("Finalizer".equals(name) && info.getLockName().startsWith("java.lang.ref.ReferenceQueue$Lock"))
                continue;
