...
<<<<<<< MINE
                writer.emitStatement("return (%s) row.get%s(realm.getColumnIndices().get(\"%s\").get(\"%s\"))", fieldTypeCanonicalName, realmType, className, fieldName);
=======
...
>>>>>>> YOURS
                ...
                writer.emitStatement("realm.checkIfValid()");
<<<<<<< MINE
                writer.emitStatement("row.set%s(realm.getColumnIndices().get(\"%s\").get(\"%s\"), (%s) value)", realmType, className, fieldName, castingType);
=======
...
<<<<<<< MINE
                ...
                writer.emitStatement("return realm.get(%s.class, row.getLink(realm.getColumnIndices().get(\"%s\").get(\"%s\")))", fieldTypeCanonicalName, className, fieldName);
=======
...
>>>>>>> YOURS
                ...
                writer.beginMethod(fieldTypeCanonicalName, metadata.getGetter(fieldName), EnumSet.of(Modifier.PUBLIC));
<<<<<<< MINE
                writer.emitStatement("return new RealmList<%s>(%s.class, row.getLinkList(realm.getColumnIndices().get(\"%s\").get(\"%s\")), realm)", genericType, genericType, className, fieldName);
=======
