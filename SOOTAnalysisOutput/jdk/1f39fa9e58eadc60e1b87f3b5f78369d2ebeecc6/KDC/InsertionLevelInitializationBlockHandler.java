...
public class KDC {
    ...
    protected byte[] processTgsReq(byte[] in) throws Exception {
        ...
        try {
            ...
            EncTicketPart enc = new EncTicketPart(tFlags, key, cname, new TransitedEncoding(1, new byte[0]), new KerberosTime(new Date()), body.from, till, renewTill, body.addresses != null ? body.addresses : etp.caddr, null);
            ...
            EncTGSRepPart enc_part = new EncTGSRepPart(key, new LastReq(new LastReqEntry[] { new LastReqEntry(0, new KerberosTime(new Date().getTime() - 10000)) }), body.getNonce(), new KerberosTime(new Date().getTime() + 1000 * 3600 * 24), tFlags, new KerberosTime(new Date()), body.from, till, renewTill, service, body.addresses);
