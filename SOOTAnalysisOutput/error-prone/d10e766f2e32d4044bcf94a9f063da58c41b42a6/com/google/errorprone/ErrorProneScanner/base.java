...
public class ErrorProneScanner extends Scanner {
    ...
    private Set<Class<? extends Annotation>> customSuppressionAnnotations = new HashSet<Class<? extends Annotation>>();
    ...
    private static final List<? extends Class<? extends BugChecker>> ALL_CHECKERS = Arrays.asList(SelfEquals.class, OrderingFrom.class, PreconditionsCheckNotNull.class, PreconditionsExpensiveString.class, PreconditionsCheckNotNullPrimitive.class, CollectionIncompatibleType.class, ArrayEquals.class, ArrayToString.class, ReturnValueIgnored.class, NonRuntimeAnnotation.class, InvalidPatternSyntax.class, MalformedFormatString.class, MisusedFormattingLogger.class, ModifyingCollectionWithItself.class, PreconditionsTooManyArgs.class, CheckReturnValue.class, DeadException.class, InjectAssistedInjectAndInjectOnConstructors.class, InjectMoreThanOneQualifier.class, InjectMoreThanOneScopeAnnotationOnClass.class, InjectScopeAnnotationOnInterfaceOrAbstractClass.class, InjectOverlappingQualifierAndScopeAnnotation.class, FallThroughSuppression.class, SuppressWarningsDeprecated.class, InjectJavaxInjectOnAbstractMethod.class, EmptyIfStatement.class, EmptyStatement.class, NumericEquality.class, StringEquality.class, SelfEquality.class, BadShiftAmount.class, ArrayToStringConcatenation.class, ComparisonOutOfRange.class, SelfAssignment.class, GuiceAssistedParameters.class, CovariantEquals.class, JUnit3TestNotRun.class, JUnit4TestNotRun.class, TryFailThrowable.class, WrongParameterPackage.class, LongLiteralLowerCaseSuffix.class, ArrayToStringCompoundAssignment.class, InjectScopeOrQualifierAnnotationRetention.class, InjectInvalidTargetingOnScopingAnnotation.class, GuiceAssistedInjectScoping.class, GuiceOverridesGuiceInjectableMethod.class, GuiceOverridesJavaxInjectableMethod.class, InjectAssistedInjectAndInjectOnSameConstructor.class, InjectMoreThanOneInjectableConstructor.class, InjectJavaxInjectOnFinalField.class, GuiceInjectOnFinalField.class, InjectedConstructorAnnotations.class, ClassCanBeStatic.class, ElementsCountedInLoop.class, ProtoFieldNullComparison.class, WaitNotInLoop.class, DepAnn.class, DivZero.class, Overrides.class, Finally.class, StaticAccessedFromInstance.class, ArrayHashCode.class, PrimitiveArrayPassedToVarargsMethod.class, IncrementDecrementVolatile.class, GuardedByValidator.class, ThreadSafe.class);
    ...
    @Override
    protected void setDisabledChecks(Set<String> disabledChecks) throws InvalidCommandLineOptionException {
        ...
        for (String checkName : disabledChecks) {
            ...
            if (checker != null && !checker.isDisableable()) {
                throw new InvalidCommandLineOptionException("error-prone check " + checkName + " may not be disabled");
            }
        }
    }
    ...
    private final List<ArrayAccessTreeMatcher> arrayAccessMatchers = new ArrayList<ArrayAccessTreeMatcher>();

    private final List<ArrayTypeTreeMatcher> arrayTypeMatchers = new ArrayList<ArrayTypeTreeMatcher>();

    private final List<AssertTreeMatcher> assertMatchers = new ArrayList<AssertTreeMatcher>();

    private final List<AssignmentTreeMatcher> assignmentMatchers = new ArrayList<AssignmentTreeMatcher>();

    private final List<BinaryTreeMatcher> binaryMatchers = new ArrayList<BinaryTreeMatcher>();

    private final List<BlockTreeMatcher> blockMatchers = new ArrayList<BlockTreeMatcher>();

    private final List<BreakTreeMatcher> breakMatchers = new ArrayList<BreakTreeMatcher>();

    private final List<CaseTreeMatcher> caseMatchers = new ArrayList<CaseTreeMatcher>();

    private final List<CatchTreeMatcher> catchMatchers = new ArrayList<CatchTreeMatcher>();

    private final List<ClassTreeMatcher> classMatchers = new ArrayList<ClassTreeMatcher>();

    private final List<CompilationUnitTreeMatcher> compilationUnitMatchers = new ArrayList<CompilationUnitTreeMatcher>();
    ...
    private final List<ContinueTreeMatcher> continueMatchers = new ArrayList<ContinueTreeMatcher>();

    private final List<DoWhileLoopTreeMatcher> doWhileLoopMatchers = new ArrayList<DoWhileLoopTreeMatcher>();

    private final List<EmptyStatementTreeMatcher> emptyStatementMatchers = new ArrayList<EmptyStatementTreeMatcher>();

    private final List<EnhancedForLoopTreeMatcher> enhancedForLoopMatchers = new ArrayList<EnhancedForLoopTreeMatcher>();

    private final List<ExpressionStatementTreeMatcher> expressionStatementMatchers = new ArrayList<ExpressionStatementTreeMatcher>();

    private final List<ForLoopTreeMatcher> forLoopMatchers = new ArrayList<ForLoopTreeMatcher>();

    private final List<IdentifierTreeMatcher> identifierMatchers = new ArrayList<IdentifierTreeMatcher>();

    private final List<IfTreeMatcher> ifMatchers = new ArrayList<IfTreeMatcher>();

    private final List<ImportTreeMatcher> importMatchers = new ArrayList<ImportTreeMatcher>();

    private final List<InstanceOfTreeMatcher> instanceOfMatchers = new ArrayList<InstanceOfTreeMatcher>();

    private final List<LabeledStatementTreeMatcher> labeledStatementMatchers = new ArrayList<LabeledStatementTreeMatcher>();

    private final List<LiteralTreeMatcher> literalMatchers = new ArrayList<LiteralTreeMatcher>();

    private final List<MemberSelectTreeMatcher> memberSelectMatchers = new ArrayList<MemberSelectTreeMatcher>();
    ...
    private final List<ModifiersTreeMatcher> modifiersMatchers = new ArrayList<ModifiersTreeMatcher>();

    private final List<NewArrayTreeMatcher> newArrayMatchers = new ArrayList<NewArrayTreeMatcher>();

    private final List<NewClassTreeMatcher> newClassMatchers = new ArrayList<NewClassTreeMatcher>();

    private final List<ParameterizedTypeTreeMatcher> parameterizedTypeMatchers = new ArrayList<ParameterizedTypeTreeMatcher>();

    private final List<ParenthesizedTreeMatcher> parenthesizedMatchers = new ArrayList<ParenthesizedTreeMatcher>();

    private final List<PrimitiveTypeTreeMatcher> primitiveTypeMatchers = new ArrayList<PrimitiveTypeTreeMatcher>();

    private final List<ReturnTreeMatcher> returnMatchers = new ArrayList<ReturnTreeMatcher>();

    private final List<SwitchTreeMatcher> switchMatchers = new ArrayList<SwitchTreeMatcher>();

    private final List<SynchronizedTreeMatcher> synchronizedMatchers = new ArrayList<SynchronizedTreeMatcher>();

    private final List<ThrowTreeMatcher> throwMatchers = new ArrayList<ThrowTreeMatcher>();

    private final List<TryTreeMatcher> tryMatchers = new ArrayList<TryTreeMatcher>();

    private final List<TypeCastTreeMatcher> typeCastMatchers = new ArrayList<TypeCastTreeMatcher>();

    private final List<TypeParameterTreeMatcher> typeParameterMatchers = new ArrayList<TypeParameterTreeMatcher>();

    private final List<UnaryTreeMatcher> unaryMatchers = new ArrayList<UnaryTreeMatcher>();

    private final List<VariableTreeMatcher> variableMatchers = new ArrayList<VariableTreeMatcher>();

    private final List<WhileLoopTreeMatcher> whileLoopMatchers = new ArrayList<WhileLoopTreeMatcher>();

    private final List<WildcardTreeMatcher> wildcardMatchers = new ArrayList<WildcardTreeMatcher>();
    ...
    public Void visitAnnotation(AnnotationTree tree, VisitorState visitorState) {
        ...
        for (AnnotationTreeMatcher matcher : annotationMatchers) {
            if (isSuppressedOrDisabled(matcher))
                continue;
    ...
    public Void visitCompilationUnit(CompilationUnitTree tree, VisitorState visitorState) {
        ...
        for (CompilationUnitTreeMatcher matcher : compilationUnitMatchers) {
            if (isSuppressedOrDisabled(matcher))
                continue;
            reportMatch(matcher.matchCompilationUnit(tree.getPackageAnnotations(), tree.getPackageName(), tree.getImports(), state), tree, state);
        }
