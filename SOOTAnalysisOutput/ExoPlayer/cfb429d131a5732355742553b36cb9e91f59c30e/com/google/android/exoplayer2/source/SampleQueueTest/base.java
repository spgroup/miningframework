...
public final class SampleQueueTest {
    ...
    private static final Format[] ENCRYPTED_SAMPLES_FORMATS = new Format[] { FORMAT_ENCRYPTED, FORMAT_ENCRYPTED, FORMAT_1, FORMAT_ENCRYPTED };
    ...
    private void writeTestDataWithEncryptedSections() {
        writeTestData(ENCRYPTED_SAMPLES_DATA, ENCRYPTED_SAMPLES_SIZES, ENCRYPTED_SAMPLES_OFFSETS, ENCRYPTED_SAMPLE_TIMESTAMPS, ENCRYPTED_SAMPLES_FORMATS, ENCRYPTED_SAMPLES_FLAGS);
    }
    ...
    private void assertReadEncryptedSample(int sampleIndex) {
        ...
        assertReadSample(ENCRYPTED_SAMPLE_TIMESTAMPS[sampleIndex], isKeyFrame, isEncrypted, sampleData, 0, ENCRYPTED_SAMPLES_SIZES[sampleIndex] - (isEncrypted ? 2 : 0));
    }
    ...
    private void assertResult(int expectedResult, boolean allowOnlyClearBuffers) {
        int obtainedResult = sampleQueue.read(formatHolder, inputBuffer, allowOnlyClearBuffers, false, 0);
