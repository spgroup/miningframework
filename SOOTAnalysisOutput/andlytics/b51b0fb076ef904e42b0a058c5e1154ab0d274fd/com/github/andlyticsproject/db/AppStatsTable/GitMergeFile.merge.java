...
public final class AppStatsTable implements BaseColumns {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://" + AndlyticsContentProvider.AUTHORITY + "/" + DATABASE_TABLE_NAME);
...
<<<<<<< MINE
    public static final String TABLE_CREATE_STATS = "create table " + AppStatsTable.DATABASE_TABLE_NAME + " (_id integer primary key autoincrement, " + AppStatsTable.KEY_STATS_PACKAGENAME + " text not null," + AppStatsTable.KEY_STATS_REQUESTDATE + " date not null," + AppStatsTable.KEY_STATS_DOWNLOADS + " integer," + AppStatsTable.KEY_STATS_INSTALLS + " integer," + AppStatsTable.KEY_STATS_COMMENTS + " integer," + AppStatsTable.KEY_STATS_MARKETERANKING + " integer," + AppStatsTable.KEY_STATS_CATEGORYRANKING + " integer," + AppStatsTable.KEY_STATS_5STARS + " integer," + AppStatsTable.KEY_STATS_4STARS + " integer," + AppStatsTable.KEY_STATS_3STARS + " integer," + AppStatsTable.KEY_STATS_2STARS + " integer," + AppStatsTable.KEY_STATS_1STARS + " integer," + AppStatsTable.KEY_STATS_VERSIONCODE + " integer, " + KEY_STATS_NUM_ERRORS + " integer)";
=======
    public static final String KEY_STATS_TOTAL_REVENUE = "totalrevenue";

    public static final String KEY_STATS_CURRENCY = "currency";

    public static final String TABLE_CREATE_STATS = "create table " + AppStatsTable.DATABASE_TABLE_NAME + " (_id integer primary key autoincrement, " + AppStatsTable.KEY_STATS_PACKAGENAME + " text not null," + AppStatsTable.KEY_STATS_REQUESTDATE + " date not null," + AppStatsTable.KEY_STATS_DOWNLOADS + " integer," + AppStatsTable.KEY_STATS_INSTALLS + " integer," + AppStatsTable.KEY_STATS_COMMENTS + " integer," + AppStatsTable.KEY_STATS_MARKETERANKING + " integer," + AppStatsTable.KEY_STATS_CATEGORYRANKING + " integer," + AppStatsTable.KEY_STATS_5STARS + " integer," + AppStatsTable.KEY_STATS_4STARS + " integer," + AppStatsTable.KEY_STATS_3STARS + " integer," + AppStatsTable.KEY_STATS_2STARS + " integer," + AppStatsTable.KEY_STATS_1STARS + " integer," + AppStatsTable.KEY_STATS_VERSIONCODE + " integer, " + AppStatsTable.KEY_STATS_NUM_ERRORS + " integer, " + AppStatsTable.KEY_STATS_TOTAL_REVENUE + " double, " + AppStatsTable.KEY_STATS_CURRENCY + " text)";
>>>>>>> YOURS
...
<<<<<<< MINE
=======
        PROJECTION_MAP.put(AppStatsTable.KEY_STATS_TOTAL_REVENUE, AppStatsTable.KEY_STATS_TOTAL_REVENUE);
        PROJECTION_MAP.put(AppStatsTable.KEY_STATS_CURRENCY, AppStatsTable.KEY_STATS_CURRENCY);
>>>>>>> YOURS
    }
}
