...
public class ConstMethod extends VMObject {
    ...
    public int getLineNumberFromBCI(int bci) {
        ...
        if (hasLineNumberTable()) {
            CompressedLineNumberReadStream stream = new CompressedLineNumberReadStream(getAddress(), (int) offsetOfCompressedLineNumberTable());
    ...
    private long offsetOfMethodParametersLength() {
        ...
        return hasGenericSignature() ? offsetOfLastU2Element() - sizeofShort : offsetOfLastU2Element();
    }
