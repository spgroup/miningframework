...
public class OnboardingPrefs<T extends Launcher> {
    ...
    @StringDef(value = { HOME_BOUNCE_SEEN, SHELF_BOUNCE_SEEN, HOTSEAT_LONGPRESS_TIP_SEEN })
    @Retention(RetentionPolicy.SOURCE)
    public @interface EventBoolKey {
    }

    @StringDef(value = { HOME_BOUNCE_COUNT, SHELF_BOUNCE_COUNT, HOTSEAT_DISCOVERY_TIP_COUNT })
    @Retention(RetentionPolicy.SOURCE)
