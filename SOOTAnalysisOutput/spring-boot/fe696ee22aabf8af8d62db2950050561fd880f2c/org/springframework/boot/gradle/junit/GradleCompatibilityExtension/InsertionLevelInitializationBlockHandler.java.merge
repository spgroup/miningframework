...
<<<<<<< MINE
            GRADLE_VERSIONS = Arrays.asList("6.3", "6.4.1", "6.5.1", "6.6.1", "6.7.1", "current", "6.9-rc-1");
=======
            GRADLE_VERSIONS = Arrays.asList("6.3", "6.4.1", "6.5.1", "6.6.1", "6.7.1", "default", "6.9-rc-2");
>>>>>>> YOURS
        } else {
<<<<<<< MINE
            GRADLE_VERSIONS = Arrays.asList("5.6.4", "6.3", "6.4.1", "6.5.1", "6.6.1", "6.7.1", "current", "6.9-rc-1");
=======
            GRADLE_VERSIONS = Arrays.asList("5.6.4", "6.3", "6.4.1", "6.5.1", "6.6.1", "6.7.1", "default", "6.9-rc-2");
>>>>>>> YOURS
        }
    }
    ...
    public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext context) {
        return GRADLE_VERSIONS.stream().flatMap((version) -> {
            ...
            boolean configurationCache = AnnotationUtils.findAnnotation(context.getRequiredTestClass(), GradleCompatibility.class).get().configurationCache();
