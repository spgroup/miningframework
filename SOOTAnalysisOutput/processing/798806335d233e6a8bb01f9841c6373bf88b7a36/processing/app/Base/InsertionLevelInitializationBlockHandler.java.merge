...
public class Base {
    ...
    static private String VERSION_NAME = "0232";
    ...
    private void buildCoreModes() {
        ...
        Mode pdexMode = ModeContribution.load(this, getContentFile("modes/ExperimentalMode"), "processing.mode.experimental.ExperimentalMode").getMode();
    ...
    public Base(String[] args) throws Exception {
        ...
        exampleManagerFrame = new ContributionManagerDialog(ContributionType.EXAMPLES_PACKAGE);
    ...
    static private void packageListFromFolder(File dir, String sofar, Map<String, Object> map) {
