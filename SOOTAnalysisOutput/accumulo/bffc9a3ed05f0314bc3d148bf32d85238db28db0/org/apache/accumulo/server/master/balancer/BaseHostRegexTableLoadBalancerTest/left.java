...
public abstract class BaseHostRegexTableLoadBalancerTest extends HostRegexTableLoadBalancer {
    ...
    protected static class TestServerConfigurationFactory extends ServerConfigurationFactory {
        ...
        public TableConfiguration getTableConfiguration(final TableId tableId) {
            NamespaceConfiguration dummyConf = new NamespaceConfiguration(Namespace.DEFAULT.id(), context, DefaultConfiguration.getInstance());
    ...
    protected boolean tabletInBounds(KeyExtent ke, TServerInstance tsi) {
        ...
        if (tid.equals("1") && (host.equals("192.168.0.1") || host.equals("192.168.0.2") || host.equals("192.168.0.3") || host.equals("192.168.0.4") || host.equals("192.168.0.5"))) {
            return true;
        } else if (tid.equals("2") && (host.equals("192.168.0.6") || host.equals("192.168.0.7") || host.equals("192.168.0.8") || host.equals("192.168.0.9") || host.equals("192.168.0.10"))) {
            return true;
        } else
            return tid.equals("3") && (host.equals("192.168.0.11") || host.equals("192.168.0.12") || host.equals("192.168.0.13") || host.equals("192.168.0.14") || host.equals("192.168.0.15"));
    }
