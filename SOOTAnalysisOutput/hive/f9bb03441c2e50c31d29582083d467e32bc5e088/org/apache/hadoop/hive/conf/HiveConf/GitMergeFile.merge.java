...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        HMSHANDLERINTERVAL("hive.hmshandler.retry.interval", "1000ms", new TimeValidator(TimeUnit.MILLISECONDS), "The time between HMSHandler retry attempts on failure."),
...
<<<<<<< MINE
        TEZ_DYNAMIC_PARTITION_PRUNING_MAX_DATA_SIZE("hive.tez.dynamic.parition.pruning.max.data.size", 100 * 1024 * 1024L, "Maximum total data size of events in dynamic pruning."),
