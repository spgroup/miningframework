...
public class SctpNet {
    ...
    static <T> void setSocketOption(int fd, SctpSocketOption<T> name, T value, int assocId) throws IOException {
        if (value == null)
        ...
        if (name.equals(SCTP_INIT_MAXSTREAMS)) {
            ...
            if (name.equals(SCTP_PRIMARY_ADDR)) {
                ...
                setPrimAddrOption0(fd, assocId, inetAddress, netAddr.getPort());
            } else {
