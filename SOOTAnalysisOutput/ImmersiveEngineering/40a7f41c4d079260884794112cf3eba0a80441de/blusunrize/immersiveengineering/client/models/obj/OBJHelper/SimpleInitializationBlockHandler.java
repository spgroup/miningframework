...
public class OBJHelper {
    ...
    static {
        try {
            ...
            OBJModel2_makeQuad = OBJModel.class.getDeclaredMethod("makeQuad", int[][].class, int.class, Vector4f.class, Vector4f.class, TextureAtlasSprite.class, TransformationMatrix.class);
