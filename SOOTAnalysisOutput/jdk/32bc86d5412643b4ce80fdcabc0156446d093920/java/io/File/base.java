...
public class File implements Serializable, Comparable<File> {
    ...
    private static String getTempDir() {
        if (tmpdir == null)
            tmpdir = fs.normalize(AccessController.doPrivileged(new GetPropertyAction("java.io.tmpdir")));
        return tmpdir;
    }
    ...
    static {
        sun.misc.SharedSecrets.setJavaIODeleteOnExitAccess(new sun.misc.JavaIODeleteOnExitAccess() {
