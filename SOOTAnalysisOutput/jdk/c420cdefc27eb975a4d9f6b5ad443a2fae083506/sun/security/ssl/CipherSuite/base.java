...
final class CipherSuite implements Comparable {
    ...
    private static void add(String name, int id, int priority, KeyExchange keyExchange, BulkCipher cipher, boolean allowed) {
        CipherSuite c = new CipherSuite(name, id, priority, keyExchange, cipher, allowed);
    ...
    final static class BulkCipher {
        ...
        CipherBox newCipher(ProtocolVersion version, SecretKey key, IvParameterSpec iv, boolean encrypt) throws NoSuchAlgorithmException {
