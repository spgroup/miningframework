...
public class MetafactoryDescriptorTest {
    ...
    public static class C {
        ...
        public static boolean m_boolean(String arg) {
            return true;
        }

        public static char m_char(String arg) {
            return 'x';
        }

        public static byte m_byte(String arg) {
            return 12;
        }

        public static short m_short(String arg) {
            return 12;
        }

        public static int m_int(String arg) {
            return 12;
        }

        public static long m_long(String arg) {
            return 12;
        }

        public static float m_float(String arg) {
            return 12;
        }

        public static double m_double(String arg) {
            return 12;
        }

        public static String m_String(String arg) {
            return "";
        }

        public static Integer m_Integer(String arg) {
            return 23;
        }

        public static Object m_Object(String arg) {
            return new Object();
        }

        public static String n_boolean(boolean arg) {
            return "";
        }

        public static String n_char(char arg) {
            return "";
        }

        public static String n_byte(byte arg) {
            return "";
        }

        public static String n_short(short arg) {
            return "";
        }

        public static String n_int(int arg) {
            return "";
        }

        public static String n_long(long arg) {
            return "";
        }

        public static String n_float(float arg) {
            return "";
        }

        public static String n_double(double arg) {
            return "";
        }

        public static String n_String(String arg) {
            return "";
        }

        public static String n_Integer(Integer arg) {
            return "";
        }

        public static String n_Object(Object arg) {
            return "";
        }
    ...
    public static void main(String... args) {
        Class<?>[] t = { void.class, boolean.class, char.class, byte.class, short.class, int.class, long.class, float.class, double.class, String.class, Integer.class, Object.class };
        for (int i = 0; i < t.length; i++) {
            ...
            for (int j = 0; j < t.length; j++) {
                ...
                testBridge(correctRet, m, mt(t[i], String.class), mt(t[i], String.class), mt(t[j], Object.class));
                testBridge(correctRet, m, mt(t[i], String.class), mt(t[i], String.class), mt(t[i], CharSequence.class), mt(t[j], Object.class));
                if (t[i] != void.class && t[j] != void.class) {
                    ...
                    testBridge(correctParam, n, mt(String.class, t[i]), mt(String.class, t[i]), mt(Object.class, t[j]));
                    testBridge(correctParam, n, mt(String.class, t[i]), mt(String.class, t[i]), mt(CharSequence.class, t[i]), mt(Object.class, t[j]));
                }
            }
        }
    }
    ...
    static void tryMetafactory(boolean correct, MethodHandle mh, MethodType instMT, MethodType samMT) {
        try {
            LambdaMetafactory.metafactory(lookup, "run", mt(I.class), samMT, mh, instMT);
            if (!correct) {
                throw new AssertionError("Unexpected linkage without error:" + " impl=" + mh + ", inst=" + instMT + ", sam=" + samMT);
            }
        } catch (LambdaConversionException e) {
            if (correct) {
                throw new AssertionError("Unexpected linkage error:" + " e=" + e + ", impl=" + mh + ", inst=" + instMT + ", sam=" + samMT);
            }
        }
    }

    static void tryAltMetafactory(boolean correct, MethodHandle mh, MethodType instMT, MethodType samMT, MethodType... bridgeMTs) {
        ...
        try {
            ...
            if (!correct) {
                throw new AssertionError("Unexpected linkage without error:" + " impl=" + mh + ", inst=" + instMT + ", sam=" + samMT + ", bridges=" + Arrays.toString(bridgeMTs));
            }
        } catch (LambdaConversionException e) {
            if (correct) {
                throw new AssertionError("Unexpected linkage error:" + " e=" + e + ", impl=" + mh + ", inst=" + instMT + ", sam=" + samMT + ", bridges=" + Arrays.toString(bridgeMTs));
            }
        }
    }
