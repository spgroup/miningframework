...
class PainlessParser extends Parser {
    ...
    public static final int WS = 1, COMMENT = 2, LBRACK = 3, RBRACK = 4, LBRACE = 5, RBRACE = 6, LP = 7, RP = 8, DOT = 9, COMMA = 10, SEMICOLON = 11, IF = 12, ELSE = 13, WHILE = 14, DO = 15, FOR = 16, CONTINUE = 17, BREAK = 18, RETURN = 19, NEW = 20, TRY = 21, CATCH = 22, THROW = 23, BOOLNOT = 24, BWNOT = 25, MUL = 26, DIV = 27, REM = 28, ADD = 29, SUB = 30, LSH = 31, RSH = 32, USH = 33, LT = 34, LTE = 35, GT = 36, GTE = 37, EQ = 38, EQR = 39, NE = 40, NER = 41, BWAND = 42, XOR = 43, BWOR = 44, BOOLAND = 45, BOOLOR = 46, COND = 47, COLON = 48, REF = 49, INCR = 50, DECR = 51, ASSIGN = 52, AADD = 53, ASUB = 54, AMUL = 55, ADIV = 56, AREM = 57, AAND = 58, AXOR = 59, AOR = 60, ALSH = 61, ARSH = 62, AUSH = 63, OCTAL = 64, HEX = 65, INTEGER = 66, DECIMAL = 67, STRING = 68, TRUE = 69, FALSE = 70, NULL = 71, TYPE = 72, ID = 73, DOTINTEGER = 74, DOTID = 75;

    public static final int RULE_source = 0, RULE_statement = 1, RULE_trailer = 2, RULE_block = 3, RULE_empty = 4, RULE_initializer = 5, RULE_afterthought = 6, RULE_declaration = 7, RULE_decltype = 8, RULE_funcref = 9, RULE_declvar = 10, RULE_trap = 11, RULE_delimiter = 12, RULE_expression = 13, RULE_unary = 14, RULE_chain = 15, RULE_primary = 16, RULE_secondary = 17, RULE_dot = 18, RULE_brace = 19, RULE_arguments = 20, RULE_argument = 21;

    public static final String[] ruleNames = { "source", "statement", "trailer", "block", "empty", "initializer", "afterthought", "declaration", "decltype", "funcref", "declvar", "trap", "delimiter", "expression", "unary", "chain", "primary", "secondary", "dot", "brace", "arguments", "argument" };
