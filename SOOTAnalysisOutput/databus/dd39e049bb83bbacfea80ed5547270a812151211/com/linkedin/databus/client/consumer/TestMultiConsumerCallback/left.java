...
public class TestMultiConsumerCallback {
    ...
    public void testPerf() throws Exception {
        ...
        System.out.println("dataEventsReceived=" + statsCollector.getNumDataEventsReceived() + " sysEventsReceived=" + statsCollector.getNumSysEventsReceived() + " dataEventsProcessed=" + statsCollector.getNumDataEventsProcessed() + " latencyEventsProcessed=" + statsCollector.getLatencyEventsProcessed());
    ...
    public void test1ConsumerTimeout() {
        ...
        System.out.println("eventsErrProcessed =" + statsCollector.getNumErrorsProcessed() + " eventsErrReceived=" + statsCollector.getNumErrorsReceived() + " totalEvents=" + statsCollector.getNumEventsReceived() + " totalEventsProcessed=" + totalEventsProcessed);
    ...
    public void test2ConsumerTimeout() {
        ...
        List<DatabusV2ConsumerRegistration> allRegistrations = Arrays.asList(consumerReg);
        TimingOutMultiConsumerCallback callback = new TimingOutMultiConsumerCallback(allRegistrations, Executors.newCachedThreadPool(), 300, new StreamConsumerCallbackFactory(), statsCollector, 3);
        callback.setSourceMap(sourcesMap);
        ConsumerCallbackResult startConsumptionRes = callback.onStartConsumption();
