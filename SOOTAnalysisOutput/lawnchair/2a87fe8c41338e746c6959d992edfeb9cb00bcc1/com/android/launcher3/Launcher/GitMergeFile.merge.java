...
>>>>>>> YOURS
    ...
    void showOverviewMode(boolean animated) {
        mWorkspace.setVisibility(View.VISIBLE);
<<<<<<< MINE
        mStateTransitionAnimation.startAnimationToWorkspace(mState, Workspace.State.OVERVIEW, animated, null);
=======
...
<<<<<<< MINE
    public Animator startWorkspaceStateChangeAnimation(Workspace.State toState, boolean animated, boolean hasOverlaySearchBar, HashMap<View, Integer> layerViews) {
        Workspace.State fromState = mWorkspace.getState();
        Animator anim = mWorkspace.setStateWithAnimation(toState, animated, hasOverlaySearchBar, layerViews);
=======
...
<<<<<<< MINE
        mStateTransitionAnimation.startAnimationToWorkspace(mState, Workspace.State.SPRING_LOADED, true, null);
=======
