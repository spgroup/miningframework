...
public class StdDateFormat extends DateFormat {
    ...
    protected Date parseAsISO8601(String dateStr, ParsePosition pos) throws ParseException {
        try {
            ...
            throw new ParseException(String.format("Can not parse date \"%s\", problem: %s", dateStr, e.getMessage()), pos.getErrorIndex());
        }
    }
                ...
                if (start >= end) {
                    ...
                    switch(end - start) {
                        ...
                        case 1:
                            ...
                            break;
                        default:
                            throw new ParseException(String.format("Can not parse date \"%s\": invalid fractional seconds '%s'; can use at most 3 digits", dateStr, m.group(1).substring(1)), pos.getErrorIndex());
                    }
