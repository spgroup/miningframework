...
public class CompactString {
    ...
    enum StringSources {
        ...
        EMPTY(STRING_EMPTY, BYTE_ARRAY_EMTPY, CHAR_ARRAY_EMPTY, POINT_ARRAY_EMTPY),
        LDUPLICATE(STRING_LDUPLICATE, BYTE_ARRAY_LDUPLICATE, CHAR_ARRAY_LDUPLICATE, POINT_ARRAY_LDUPLICATE),
        LLONG(STRING_LLONG, BYTE_ARRAY_LLONG, CHAR_ARRAY_LLONG, POINT_ARRAY_LLONG),
        L1(STRING_L1, BYTE_ARRAY_L1, CHAR_ARRAY_L1, POINT_ARRAY_L1),
        L2(STRING_L2, BYTE_ARRAY_L2, CHAR_ARRAY_L2, POINT_ARRAY_L2),
        L4(STRING_L4, BYTE_ARRAY_L4, CHAR_ARRAY_L4, POINT_ARRAY_L4),
        UDUPLICATE(STRING_UDUPLICATE, BYTE_ARRAY_UDUPLICATE, CHAR_ARRAY_UDUPLICATE, POINT_ARRAY_UDUPLICATE),
        U1(STRING_U1, BYTE_ARRAY_U1, CHAR_ARRAY_U1, POINT_ARRAY_U1),
        U2(STRING_U2, BYTE_ARRAY_U2, CHAR_ARRAY_U2, POINT_ARRAY_U2),
        MDUPLICATE1(STRING_MDUPLICATE1, BYTE_ARRAY_MDUPLICATE1, CHAR_ARRAY_MDUPLICATE1, POINT_ARRAY_MDUPLICATE1),
        MDUPLICATE2(STRING_MDUPLICATE2, BYTE_ARRAY_MDUPLICATE2, CHAR_ARRAY_MDUPLICATE2, POINT_ARRAY_MDUPLICATE2),
        MLONG1(STRING_MLONG1, BYTE_ARRAY_MLONG1, CHAR_ARRAY_MLONG1, POINT_ARRAY_MLONG1),
        MLONG2(STRING_MLONG2, BYTE_ARRAY_MLONG2, CHAR_ARRAY_MLONG2, POINT_ARRAY_MLONG2),
        M11(STRING_M11, BYTE_ARRAY_M11, CHAR_ARRAY_M11, POINT_ARRAY_M11),
        M12(STRING_M12, BYTE_ARRAY_M12, CHAR_ARRAY_M12, POINT_ARRAY_M12),
        SUPPLEMENTARY(STRING_SUPPLEMENTARY, BYTE_ARRAY_SUPPLEMENTARY, CHAR_ARRAY_SUPPLEMENTARY, POINT_ARRAY_SUPPLEMENTARY),
        SUPPLEMENTARY_LOWERCASE(STRING_SUPPLEMENTARY_LOWERCASE, BYTE_ARRAY_SUPPLEMENTARY_LOWERCASE, CHAR_ARRAY_SUPPLEMENTARY_LOWERCASE, POINT_ARRAY_SUPPLEMENTARY_LOWERCASE);
    ...
    protected static final byte[] BYTE_ARRAY_LDUPLICATE = new byte[] { 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B' };

    protected static final char[] CHAR_ARRAY_LDUPLICATE = new char[] { 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B' };

    protected static final int[] POINT_ARRAY_LDUPLICATE = new int[] { 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B', 'A', 'B' };

    protected static final String STRING_LLONG = "ABCDEFGH";

    protected static final byte[] BYTE_ARRAY_LLONG = new byte[] { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };

    protected static final char[] CHAR_ARRAY_LLONG = new char[] { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };

    protected static final int[] POINT_ARRAY_LLONG = new int[] { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };
    ...
    protected static final char[] CHAR_ARRAY_UDUPLICATE = new char[] { '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22' };

    protected static final int[] POINT_ARRAY_UDUPLICATE = new int[] { '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22', '\uFF21', '\uFF22' };
    ...
    protected static final char[] CHAR_ARRAY_MDUPLICATE1 = new char[] { '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A' };

    protected static final int[] POINT_ARRAY_MDUPLICATE1 = new int[] { '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A' };
    ...
    protected static final char[] CHAR_ARRAY_MDUPLICATE2 = new char[] { 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21' };

    protected static final int[] POINT_ARRAY_MDUPLICATE2 = new int[] { 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21', 'A', '\uFF21' };
    ...
    protected static final char[] CHAR_ARRAY_MLONG1 = new char[] { 'A', '\uFF21', 'B', '\uFF22', 'C', '\uFF23', 'D', '\uFF24', 'E', '\uFF25', 'F', '\uFF26', 'G', '\uFF27', 'H', '\uFF28' };

    protected static final int[] POINT_ARRAY_MLONG1 = new int[] { 'A', '\uFF21', 'B', '\uFF22', 'C', '\uFF23', 'D', '\uFF24', 'E', '\uFF25', 'F', '\uFF26', 'G', '\uFF27', 'H', '\uFF28' };
    ...
    protected static final char[] CHAR_ARRAY_MLONG2 = new char[] { '\uFF21', 'A', '\uFF22', 'B', '\uFF23', 'C', '\uFF24', 'D', '\uFF25', 'E', '\uFF26', 'F', '\uFF27', 'G', '\uFF28', 'H' };

    protected static final int[] POINT_ARRAY_MLONG2 = new int[] { '\uFF21', 'A', '\uFF22', 'B', '\uFF23', 'C', '\uFF24', 'D', '\uFF25', 'E', '\uFF26', 'F', '\uFF27', 'G', '\uFF28', 'H' };
    ...
    protected static final char[] CHAR_ARRAY_SUPPLEMENTARY = new char[] { '\uD801', '\uDC00', '\uD801', '\uDC01', '\uFF21', 'A' };

    protected static final int[] POINT_ARRAY_SUPPLEMENTARY = new int[] { '\uD801', '\uDC00', '\uD801', '\uDC01', '\uFF21', 'A' };
    ...
    protected static final char[] CHAR_ARRAY_SUPPLEMENTARY_LOWERCASE = new char[] { '\uD801', '\uDC28', '\uD801', '\uDC29', '\uFF41', 'a' };

    protected static final int[] POINT_ARRAY_SUPPLEMENTARY_LOWERCASE = new int[] { '\uD801', '\uDC28', '\uD801', '\uDC29', '\uFF41', 'a' };
    ...
    private void setUpOneString(String content, byte[] ba, char[] ca, int[] cpa) throws UnsupportedEncodingException {
        final Map<String, String> m = new HashMap<>();
        m.put(SRC_BYTE_ARRAY_WITH_CHARSETNAME, new String(ba, DEFAULT_CHARSET_NAME));
    ...
    public void setUp() throws UnsupportedEncodingException {
        for (StringSources src : StringSources.values()) {
            setUpOneString(src.getString(), src.getByteArray(), src.getCharArray(), src.getIntArray());
        }
    }
