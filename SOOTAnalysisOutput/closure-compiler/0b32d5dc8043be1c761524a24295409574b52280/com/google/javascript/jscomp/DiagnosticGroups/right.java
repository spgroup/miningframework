...
public class DiagnosticGroups {
    ...
    public static final DiagnosticGroup UNNECESSARY_CASTS = DiagnosticGroups.registerGroup("unnecessaryCasts", TypeValidator.UNNECESSARY_CAST);

    @Deprecated
    public static final DiagnosticGroup INFERRED_CONST_CHECKS = DiagnosticGroups.registerGroup("inferredConstCheck", TypedScopeCreator.CANNOT_INFER_CONST_TYPE);
    ...
    public static final DiagnosticGroup NEW_CHECK_TYPES = DiagnosticGroups.registerGroup("newCheckTypes", JSTypeCreatorFromJSDoc.ALL_DIAGNOSTICS, GlobalTypeInfo.ALL_DIAGNOSTICS, NewTypeInference.ALL_DIAGNOSTICS);
    ...
    public static final DiagnosticGroup NEW_CHECK_TYPES_ALL_CHECKS = DiagnosticGroups.registerGroup("newCheckTypesAllChecks", JSTypeCreatorFromJSDoc.CONFLICTING_SHAPE_TYPE, NewTypeInference.NULLABLE_DEREFERENCE);

    static {
        DiagnosticGroups.registerGroup("newCheckTypesClosureClean", JSTypeCreatorFromJSDoc.CONFLICTING_EXTENDED_TYPE, JSTypeCreatorFromJSDoc.CONFLICTING_IMPLEMENTED_TYPE, JSTypeCreatorFromJSDoc.DICT_IMPLEMENTS_INTERF, JSTypeCreatorFromJSDoc.EXTENDS_NON_OBJECT, JSTypeCreatorFromJSDoc.EXTENDS_NOT_ON_CTOR_OR_INTERF, JSTypeCreatorFromJSDoc.IMPLEMENTS_WITHOUT_CONSTRUCTOR, JSTypeCreatorFromJSDoc.INHERITANCE_CYCLE, GlobalTypeInfo.ANONYMOUS_NOMINAL_TYPE, GlobalTypeInfo.CANNOT_INIT_TYPEDEF, GlobalTypeInfo.CANNOT_OVERRIDE_FINAL_METHOD, GlobalTypeInfo.CONST_WITHOUT_INITIALIZER, GlobalTypeInfo.CTOR_IN_DIFFERENT_SCOPE, GlobalTypeInfo.DUPLICATE_JSDOC, GlobalTypeInfo.DUPLICATE_PROP_IN_ENUM, GlobalTypeInfo.EXPECTED_CONSTRUCTOR, GlobalTypeInfo.EXPECTED_INTERFACE, GlobalTypeInfo.INEXISTENT_PARAM, GlobalTypeInfo.INTERFACE_METHOD_NOT_IMPLEMENTED, GlobalTypeInfo.LENDS_ON_BAD_TYPE, GlobalTypeInfo.MALFORMED_ENUM, GlobalTypeInfo.MISPLACED_CONST_ANNOTATION, GlobalTypeInfo.ONE_TYPE_FOR_MANY_VARS, GlobalTypeInfo.STRUCTDICT_WITHOUT_CTOR, GlobalTypeInfo.SUPER_INTERFACES_HAVE_INCOMPATIBLE_PROPERTIES, GlobalTypeInfo.UNDECLARED_NAMESPACE, GlobalTypeInfo.UNKNOWN_OVERRIDE, NewTypeInference.ASSERT_FALSE, NewTypeInference.CANNOT_BIND_CTOR, NewTypeInference.CONST_REASSIGNED, NewTypeInference.CONSTRUCTOR_NOT_CALLABLE, NewTypeInference.CROSS_SCOPE_GOTCHA, NewTypeInference.FORIN_EXPECTS_STRING_KEY, NewTypeInference.ILLEGAL_OBJLIT_KEY, NewTypeInference.IN_USED_WITH_STRUCT, NewTypeInference.INVALID_INFERRED_RETURN_TYPE, NewTypeInference.UNKNOWN_ASSERTION_TYPE, NewTypeInference.UNKNOWN_TYPEOF_VALUE);
    }
    ...
    public static final DiagnosticGroup CONST = DiagnosticGroups.registerGroup("const", CheckAccessControls.CONST_PROPERTY_DELETED, CheckAccessControls.CONST_PROPERTY_REASSIGNED_VALUE, ConstCheck.CONST_REASSIGNED_VALUE_ERROR, NewTypeInference.CONST_REASSIGNED, NewTypeInference.CONST_PROPERTY_REASSIGNED);

    public static final DiagnosticGroup CONSTANT_PROPERTY = DiagnosticGroups.registerGroup("constantProperty", CheckAccessControls.CONST_PROPERTY_DELETED, CheckAccessControls.CONST_PROPERTY_REASSIGNED_VALUE, NewTypeInference.CONST_PROPERTY_REASSIGNED);
    ...
    public static final DiagnosticGroup DUPLICATE_VARS = DiagnosticGroups.registerGroup("duplicate", VarCheck.VAR_MULTIPLY_DECLARED_ERROR, TypeValidator.DUP_VAR_DECLARATION, TypeValidator.DUP_VAR_DECLARATION_TYPE_MISMATCH, VariableReferenceCheck.REDECLARED_VARIABLE, GlobalTypeInfo.REDECLARED_PROPERTY);
    ...
    public static final DiagnosticGroup EXTRA_REQUIRE = DiagnosticGroups.registerGroup("extraRequire", CheckRequiresForConstructors.DUPLICATE_REQUIRE_WARNING, CheckRequiresForConstructors.EXTRA_REQUIRE_WARNING);
    ...
    public static final DiagnosticGroup MISPLACED_TYPE_ANNOTATION = DiagnosticGroups.registerGroup("misplacedTypeAnnotation", CheckJSDoc.DISALLOWED_MEMBER_JSDOC, CheckJSDoc.MISPLACED_ANNOTATION, CheckJSDoc.MISPLACED_MSG_ANNOTATION);

    public static final DiagnosticGroup SUSPICIOUS_CODE = DiagnosticGroups.registerGroup("suspiciousCode", CheckSuspiciousCode.SUSPICIOUS_SEMICOLON, CheckSuspiciousCode.SUSPICIOUS_COMPARISON_WITH_NAN, CheckSuspiciousCode.SUSPICIOUS_IN_OPERATOR, CheckSuspiciousCode.SUSPICIOUS_INSTANCEOF_LEFT_OPERAND, CheckSuspiciousCode.SUSPICIOUS_NEGATED_LEFT_OPERAND_OF_IN_OPERATOR, TypeCheck.DETERMINISTIC_TEST);
    ...
    public static final DiagnosticGroup LINT_CHECKS = DiagnosticGroups.registerGroup("lintChecks", CheckArguments.BAD_ARGUMENTS_USAGE, CheckDuplicateCase.DUPLICATE_CASE, CheckEmptyStatements.USELESS_EMPTY_STATEMENT, CheckEnums.COMPUTED_PROP_NAME_IN_ENUM, CheckEnums.DUPLICATE_ENUM_VALUE, CheckEnums.ENUM_PROP_NOT_CONSTANT, CheckEnums.SHORTHAND_ASSIGNMENT_IN_ENUM, CheckInterfaces.INTERFACE_FUNCTION_NOT_EMPTY, CheckInterfaces.INTERFACE_SHOULD_NOT_TAKE_ARGS, CheckJSDocStyle.MISSING_PARAMETER_JSDOC, CheckJSDocStyle.MISSING_JSDOC, CheckJSDocStyle.EXTERNS_FILES_SHOULD_BE_ANNOTATED, CheckJSDocStyle.INCORRECT_PARAM_NAME, CheckJSDocStyle.MIXED_PARAM_JSDOC_STYLES, CheckJSDocStyle.MUST_BE_PRIVATE, CheckJSDocStyle.OPTIONAL_PARAM_NOT_MARKED_OPTIONAL, CheckJSDocStyle.OPTIONAL_TYPE_NOT_USING_OPTIONAL_NAME, CheckJSDocStyle.WRONG_NUMBER_OF_PARAMS, CheckPrototypeProperties.ILLEGAL_PROTOTYPE_MEMBER, CheckRequiresAndProvidesSorted.REQUIRES_NOT_SORTED, CheckRequiresAndProvidesSorted.PROVIDES_NOT_SORTED, CheckRequiresAndProvidesSorted.PROVIDES_AFTER_REQUIRES, CheckRequiresAndProvidesSorted.MULTIPLE_MODULES_IN_FILE, CheckRequiresAndProvidesSorted.MODULE_AND_PROVIDES, CheckUnusedPrivateProperties.UNUSED_PRIVATE_PROPERTY, CheckUselessBlocks.USELESS_BLOCK, Es6RewriteArrowFunction.THIS_REFERENCE_IN_ARROWFUNC_OF_OBJLIT, RhinoErrorReporter.JSDOC_MISSING_BRACES_WARNING, RhinoErrorReporter.JSDOC_MISSING_TYPE_WARNING, RhinoErrorReporter.TOO_MANY_TEMPLATE_PARAMS, VariableReferenceCheck.UNUSED_LOCAL_ASSIGNMENT);

    public static final DiagnosticGroup ANALYZER_CHECKS = DiagnosticGroups.registerGroup("analyzerChecks", CheckForInOverArray.FOR_IN_OVER_ARRAY, CheckNullableReturn.NULLABLE_RETURN, CheckNullableReturn.NULLABLE_RETURN_WITH_NAME, ImplicitNullabilityCheck.IMPLICITLY_NULLABLE_JSDOC);
    ...
    static {
        ...
        DiagnosticGroups.registerGroup("lateProvide", ProcessClosurePrimitives.LATE_PROVIDE_ERROR);
