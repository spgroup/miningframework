...
public class ManagementFactoryHelper {
    ...
    static final class LoggingMXBeanSupport {
        ...
        final static Object loggingImpl = AccessController.doPrivileged(new PrivilegedAction<Object>() {
    ...
    static class PlatformLoggingImpl implements LoggingMXBean {
        ...
        final static java.util.logging.LoggingMXBean impl = (java.util.logging.LoggingMXBean) LoggingMXBeanSupport.loggingImpl;
