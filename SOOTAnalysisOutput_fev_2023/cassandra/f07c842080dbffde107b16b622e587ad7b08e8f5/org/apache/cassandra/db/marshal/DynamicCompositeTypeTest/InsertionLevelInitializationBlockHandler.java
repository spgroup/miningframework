...
public class DynamicCompositeTypeTest {
    ...
    public static void defineSchema() throws ConfigurationException {
        ...
        SchemaLoader.createKeyspace(KEYSPACE1, SimpleStrategy.class, KSMetaData.optsWithRF(1), CFMetaData.denseCFMetaData(KEYSPACE1, CF_STANDARDDYNCOMPOSITE, dynamicComposite));
    }

    static {
        for (int i = 0; i < UUID_COUNT; ++i) uuids[i] = UUIDGen.getTimeUUID();
    }
    ...
    private ByteBuffer createDynamicCompositeKey(String s, UUID uuid, int i, boolean lastIsOne, final boolean reversed) {
