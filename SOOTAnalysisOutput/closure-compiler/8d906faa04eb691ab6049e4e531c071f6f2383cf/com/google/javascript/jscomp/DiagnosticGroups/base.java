...
public class DiagnosticGroups {
    ...
    public static final Set<String> wildcardExcludedGroups = ImmutableSet.of("reportUnknownTypes", "analyzerChecks", "analyzerChecksInternal", "missingSourcesWarnings", "parsing");
    ...
    public static final DiagnosticGroup CLOSURE_DEP_METHOD_USAGE_CHECKS = DiagnosticGroups.registerGroup("closureDepMethodUsageChecks", INVALID_CLOSURE_CALL_SCOPE_ERROR, CLOSURE_CALL_CANNOT_BE_ALIASED_ERROR, CLOSURE_CALL_CANNOT_BE_ALIASED_OUTSIDE_MODULE_ERROR);
    ...
    public static final DiagnosticGroup PARSING = DiagnosticGroups.registerGroup("parsing", RhinoErrorReporter.PARSE_ERROR);
