...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        DROPIGNORESNONEXISTENT("hive.exec.drop.ignorenonexistent", true, "Do not report an error if DROP TABLE/VIEW/Index specifies a non-existent table/view/index"),
        ...
        METASTORE_FILTER_HOOK("hive.metastore.filter.hook", "org.apache.hadoop.hive.metastore.DefaultMetaStoreFilterHookImpl", "Metastore hook class for filtering the metadata read results. If hive.security.authorization.manager\n" + "is set to instance of HiveAuthorizerFactory, then this value is ignored."),
        ...
        LLAP_EXECUTION_MODE("hive.llap.execution.mode", "auto", new StringSet("auto", "none", "all", "map"), "Chooses whether query fragments will run in container or in llap"),
