...
public class HiveConf extends Configuration {
    ...
    public static enum ConfVars {
        ...
        SPARK_PREWARM_CONTAINERS("hive.spark.prewarm.containers", false, "Whether to prewarn containers for Spark." + "If enabled, Hive will spend no more than 60 seconds to wait for the containers to come up " + "before any query can be executed."),
        SPARK_PREWARM_NUM_CONTAINERS("hive.spark.prewarm.num.containers", 10, "The minimum number of containers to be prewarmed for Spark." + "Applicable only if hive.spark.prewarm.containers is set to true."),
