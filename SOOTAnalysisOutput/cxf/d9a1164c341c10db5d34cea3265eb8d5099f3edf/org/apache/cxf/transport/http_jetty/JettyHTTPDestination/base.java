...
public class JettyHTTPDestination extends AbstractHTTPDestination {
    ...
    static {
        try {
            Class<?> cls = ClassUtils.forName("org.apache.cxf.transport.http_jetty.JettyHTTPExtendedHandler", JettyHTTPDestination.class.getClassLoader());
    ...
    private JettyHTTPHandler createJettyHTTPHandler(JettyHTTPDestination jhd, boolean cmExact) {
