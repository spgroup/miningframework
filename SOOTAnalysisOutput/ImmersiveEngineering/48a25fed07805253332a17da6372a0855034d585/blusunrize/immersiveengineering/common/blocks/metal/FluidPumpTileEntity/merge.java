...
public class FluidPumpTileEntity extends IEBaseTileEntity implements ITickableTileEntity, IBlockBounds, IHasDummyBlocks, IConfigurableSides, IFluidPipe, IIEInternalFluxHandler, IBlockOverlayText {
    ...
    {
        for (Direction d : Direction.VALUES) sideConfig.put(d, IOSideConfig.NONE);
    }
    ...
    public String[] getOverlayText(PlayerEntity player, RayTraceResult mop, boolean hammer) {
        if (hammer && IEConfig.GENERAL.showTextOverlay.get() && !isDummy() && mop instanceof BlockRayTraceResult) {
            ...
            return new String[] { I18n.format(Lib.DESC_INFO + "blockSide.facing") + ": " + I18n.format(Lib.DESC_INFO + "blockSide.connectFluid." + i.func_176610_l()), I18n.format(Lib.DESC_INFO + "blockSide.opposite") + ": " + I18n.format(Lib.DESC_INFO + "blockSide.connectFluid." + j.func_176610_l()) };
        }
        return null;
    }
