        ...
        if (service == null) {
            ...
            try {
                ...
                if (serviceClassName.equals("android.content.RestrictionsManager")) {
                    service = ReflectionHelpers.callConstructor(clazz, ClassParameter.from(Context.class, RuntimeEnvironment.application), ClassParameter.from(IRestrictionsManager.class, null));
                ...
                } else if (serviceClassName.equals("android.app.SearchManager") || serviceClassName.equals("android.app.ActivityManager")) {
                    service = ReflectionHelpers.callConstructor(clazz, ClassParameter.from(Context.class, RuntimeEnvironment.application), ClassParameter.from(Handler.class, null));
                    ...
                    service = ReflectionHelpers.callConstructor(clazz, ClassParameter.from(Context.class, RuntimeEnvironment.application), ClassParameter.from(IUserManager.class, null));
                } else if (getApiLevel() >= M && serviceClassName.equals("android.hardware.fingerprint.FingerprintManager")) {
                    service = ReflectionHelpers.callConstructor(clazz, ClassParameter.from(Context.class, RuntimeEnvironment.application), ClassParameter.from(IFingerprintService.class, null));
                } else if (getApiLevel() >= O && serviceClassName.equals("android.view.autofill.AutofillManager")) {
                    service = ReflectionHelpers.callConstructor(clazz, ClassParameter.from(Context.class, RuntimeEnvironment.application), ClassParameter.from(IAutoFillManager.class, null));
