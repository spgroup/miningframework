...
abstract class MethodHandleImpl {
    ...
    static final NamedFunction NF_checkSpreadArgument, NF_guardWithCatch, NF_throwException, NF_profileBoolean;
    ...
    static {
        try {
            ...
            NF_guardWithCatch = new NamedFunction(MethodHandleImpl.class.getDeclaredMethod("guardWithCatch", MethodHandle.class, Class.class, MethodHandle.class, Object[].class));
            NF_throwException = new NamedFunction(MethodHandleImpl.class.getDeclaredMethod("throwException", Throwable.class));
            NF_profileBoolean = new NamedFunction(MethodHandleImpl.class.getDeclaredMethod("profileBoolean", boolean.class, int[].class));
        } catch (ReflectiveOperationException ex) {
            throw newInternalError(ex);
        }
    }

    static MethodHandle makeLoop(Class<?> tloop, List<Class<?>> targs, List<Class<?>> tvars, List<MethodHandle> init, List<MethodHandle> step, List<MethodHandle> pred, List<MethodHandle> fini) {
    ...
    static Object looper(MethodHandle[] init, MethodHandle[] step, MethodHandle[] pred, MethodHandle[] fini, int varSize, int nArgs, Object[] args) throws Throwable {
    ...
    static final int MH_cast = 0, MH_selectAlternative = 1, MH_copyAsPrimitiveArray = 2, MH_fillNewTypedArray = 3, MH_fillNewArray = 4, MH_arrayIdentity = 5, MH_looper = 6, MH_countedLoopPred = 7, MH_countedLoopStep = 8, MH_iteratePred = 9, MH_initIterator = 10, MH_iterateNext = 11, MH_tryFinallyExec = 12, MH_tryFinallyVoidExec = 13, MH_LIMIT = 14;
        ...
        try {
            switch(idx) {
                ...
                case MH_selectAlternative:
                    return makeIntrinsic(IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "selectAlternative", MethodType.methodType(MethodHandle.class, boolean.class, MethodHandle.class, MethodHandle.class)), Intrinsic.SELECT_ALTERNATIVE);
                case MH_looper:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "looper", MethodType.methodType(Object.class, MethodHandle[].class, MethodHandle[].class, MethodHandle[].class, MethodHandle[].class, int.class, int.class, Object[].class));
                ...
                case MH_tryFinallyExec:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "tryFinallyExecutor", MethodType.methodType(Object.class, MethodHandle.class, MethodHandle.class, Object[].class));
                case MH_tryFinallyVoidExec:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "tryFinallyVoidExecutor", MethodType.methodType(void.class, MethodHandle.class, MethodHandle.class, Object[].class));
            }
        } catch (ReflectiveOperationException ex) {
            throw newInternalError(ex);
        }
