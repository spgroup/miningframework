...
public class ProcDebuggerLocal extends DebuggerBase implements ProcDebugger {
    ...
    protected static final int cacheSize = 16 * 1024 * 1024;
    ...
    public ProcAddress readCompKlassAddress(long address) throws UnmappedAddressException, UnalignedAddressException {
    ...
    protected int getPageSize() {
        ...
        if (pagesize == -1) {
            if (PlatformInfo.getCPU().equals("sparc") || PlatformInfo.getCPU().equals("amd64"))
                pagesize = 8196;
            else
                pagesize = 4096;
        }
