...
public class StandardGraphBuilderPlugins {
    ...
    private static void registerUnsafeAtomicsPlugins(Registration r, boolean isSunMiscUnsafe, boolean explicitUnsafeNullChecks, String casPrefix, String[] memoryOrders, JavaKind[] supportedJavaKinds) {
        for (JavaKind kind : supportedJavaKinds) {
            ...
            for (String memoryOrderString : memoryOrders) {
                ...
                r.register5(casPrefix + kindName + memoryOrderString, Receiver.class, Object.class, long.class, javaClass, javaClass, new UnsafeCompareAndSwapPlugin(returnKind, kind, memoryOrder, isLogic, explicitUnsafeNullChecks));
            }
        }
    }
            ...
            if ((kind.isPrimitive() && kind != JavaKind.Void) || kind == JavaKind.Object) {
                ...
                if (sunMiscUnsafe) {
                    if (kind == JavaKind.Int || kind == JavaKind.Long || kind == JavaKind.Object) {
                        r.register4("putOrdered" + kindName, Receiver.class, Object.class, long.class, javaClass, new UnsafePutPlugin(kind, MemoryOrderMode.RELEASE, explicitUnsafeNullChecks));
                    }
                } else {
                    r.register4("put" + kindName + "Release", Receiver.class, Object.class, long.class, javaClass, new UnsafePutPlugin(kind, MemoryOrderMode.RELEASE, explicitUnsafeNullChecks));
    ...
    private static void registerGraalDirectivesPlugins(InvocationPlugins plugins, SnippetReflectionProvider snippetReflection) {
        ...
        r.register3("deoptimize", DeoptimizationAction.class, DeoptimizationReason.class, boolean.class, new DeoptimizePlugin(snippetReflection, null, null, null));
        r.register3("deoptimize", DeoptimizationAction.class, DeoptimizationReason.class, SpeculationReason.class, new DeoptimizePlugin(snippetReflection, null, null, null));
