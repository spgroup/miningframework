...
<<<<<<< MINE
        return new MTable(HiveStringUtils.normalizeIdentifier(tbl.getTableName()), mdb, convertToMStorageDescriptor(tbl.getSd()), tbl.getOwner(), tbl.getCreateTime(), tbl.getLastAccessTime(), tbl.getRetention(), convertToMFieldSchemas(tbl.getPartitionKeys()), tbl.getParameters(), tbl.getViewOriginalText(), tbl.getViewExpandedText(), tableType, tbl.isSetMmNextWriteId() ? tbl.getMmNextWriteId() : 0, tbl.isSetMmWatermarkWriteId() ? tbl.getMmWatermarkWriteId() : -1);
=======
...
>>>>>>> YOURS
    ...
    protected List<SQLPrimaryKey> getPrimaryKeysInternal(final String db_name, final String tbl_name, boolean allowSql, boolean allowJdo) throws MetaException, NoSuchObjectException {
    ...
    protected List<SQLForeignKey> getForeignKeysInternal(final String parent_db_name, final String parent_tbl_name, final String foreign_db_name, final String foreign_tbl_name, boolean allowSql, boolean allowJdo) throws MetaException, NoSuchObjectException {
