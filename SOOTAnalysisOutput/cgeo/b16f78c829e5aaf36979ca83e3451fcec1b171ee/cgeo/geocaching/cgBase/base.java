...
public class cgBase {
    ...
    private static List<cgLog> loadLogsFromDetails(final String page, final cgCache cache, final boolean friends, final boolean getDataFromPage) {
        ...
        if (!getDataFromPage) {
            ...
            final Parameters params = new Parameters("tkn", userToken, "idx", "1", "num", String.valueOf(Constants.NUMBER_OF_LOGS), "decrypt", "true", "sf", Boolean.toString(friends));
    ...
    public static StatusCode postLog(final String geocode, final String cacheid, final String[] viewstates, final LogType logType, final int year, final int month, final int day, final String log, final List<cgTrackableLog> trackables) {
        if (isEmpty(viewstates)) {
