...
<<<<<<< MINE
        SPARK_CLIENT_FUTURE_TIMEOUT("hive.spark.client.future.timeout", "60s", new TimeValidator(TimeUnit.SECONDS), "remote spark client JobHandle future timeout value in seconds."),
