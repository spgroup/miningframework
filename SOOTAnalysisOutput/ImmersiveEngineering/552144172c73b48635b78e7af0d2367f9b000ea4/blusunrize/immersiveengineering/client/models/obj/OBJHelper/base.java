...
public class OBJHelper {
    ...
    static {
        try {
            ...
            OBJModel2_makeQuad = OBJModel2.class.getDeclaredMethod("makeQuad", int[][].class, int.class, Vector4f.class, Vector4f.class, boolean.class, TextureAtlasSprite.class, VertexFormat.class, Optional.class);
    ...
    public static List<MeshWrapper> getMeshes(ModelObject object) {
        ...
        for (Object o : meshes) ret.add(new MeshWrapper(o));
        return ret;
    }

    public static Pair<BakedQuad, Direction> makeQuad(OBJModel2 model, int[][] indices, int tintIndex, Vector4f colorTint, Vector4f ambientColor, boolean isFullbright, TextureAtlasSprite texture, VertexFormat format, Optional<TRSRTransformation> transform) {
