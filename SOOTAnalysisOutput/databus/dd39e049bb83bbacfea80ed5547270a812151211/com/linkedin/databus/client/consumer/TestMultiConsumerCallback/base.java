...
public class TestMultiConsumerCallback {
    ...
    public void testPerf() throws Exception {
        ...
        MultiConsumerCallback callback = new MultiConsumerCallback(allRegistrations, executor, 60000, new StreamConsumerCallbackFactory(), statsCollector);
    ...
    public void test1StreamConsumerHappyPath() {
        ...
        List<DatabusV2ConsumerRegistration> allRegistrations = Arrays.asList(consumerReg);
        MultiConsumerCallback callback = new MultiConsumerCallback(allRegistrations, Executors.newCachedThreadPool(), 60000, new StreamConsumerCallbackFactory(), null);
        callback.setSourceMap(sourcesMap);
        DbusEventBuffer.DbusEventIterator iter = eventsBuf.acquireIterator("myIter1");
        assert iter.hasNext() : "unable to read event";
        DbusEvent event1 = iter.next();
    ...
    public void test1StreamConsumerCallFailure() {
        ...
        DatabusV2ConsumerRegistration consumerReg = new DatabusV2ConsumerRegistration(sdccMockConsumer, sources, null);
        List<DatabusV2ConsumerRegistration> allRegistrations = Arrays.asList(consumerReg);
        MultiConsumerCallback callback = new MultiConsumerCallback(allRegistrations, Executors.newCachedThreadPool(), 1000, new StreamConsumerCallbackFactory(), null);
        callback.setSourceMap(sourcesMap);
        DbusEventBuffer.DbusEventIterator iter = eventsBuf.acquireIterator("myIter1");
        assert iter.hasNext() : "unable to read event";
        DbusEvent event1 = iter.next();
    ...
    public void test1ConsumerTimeout() {
        ...
        ConsumerCallbackStats statsCollector = new ConsumerCallbackStats(1, "test", "test", true, false, null);
        List<DatabusV2ConsumerRegistration> allRegistrations = Arrays.asList(consumerReg);
        MultiConsumerCallback callback = new MultiConsumerCallback(allRegistrations, Executors.newCachedThreadPool(), 100, new StreamConsumerCallbackFactory(), statsCollector);
        callback.setSourceMap(sourcesMap);
