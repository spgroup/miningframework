...
<<<<<<< MINE
private static final Message[] TEST_MESSAGES = new Message[] { new BlockUpdateMessage(0, 0, 0, (short) 0, (short) 0), new ChunkDataMessage(0, 0, 0, chunkData, chunkData, null, null, new HashMap<Short, byte[]>()), new ClickRequestMessage((byte) 0, (byte) 0, ClickRequestMessage.Action.LEFT), new ClickResponseMessage((byte) 0, (byte) 0, ClickResponseMessage.Response.ALLOW), new CommandMessage("test", "hi"), new CuboidBlockUpdateMessage(TEST_WORLD.getUID(), Vector3.ZERO, Vector3.UP, new short[0], new short[0], new byte[0], new byte[0]), new EntityDatatableMessage(0, TEST_SERIALIZED_DATA, DeltaMap.DeltaType.SET), new LoginMessage("Spouty", 0), new SyncedMapMessage(0, SyncedMapEvent.Action.ADD, new ArrayList<Pair<Integer, String>>()), new WorldChangeMessage("world", EngineFaker.TEST_UUID, TEST_TRANSFORM, TEST_SERIALIZED_DATA, DeltaMap.DeltaType.SET), new UpdateEntityMessage(0, TEST_TRANSFORM, UpdateAction.TRANSFORM, new NullRepositionManager()), new ChunkDatatableMessage("Blank", 0, 0, 0, biomeData1, DeltaMap.DeltaType.SET) };
=======
private static final Message[] TEST_MESSAGES = new Message[] { new BlockUpdateMessage(0, 0, 0, (short) 0, (short) 0), new ChunkDataMessage(0, 0, 0, chunkData, chunkData, null, null, new HashMap<Short, byte[]>()), new ClickRequestMessage((byte) 0, (byte) 0, ClickRequestMessage.Action.LEFT), new ClickResponseMessage((byte) 0, (byte) 0, ClickResponseMessage.Response.ALLOW), new CommandMessage("test", "hi"), new CuboidBlockUpdateMessage(TEST_WORLD.getUID(), Vector3.ZERO, Vector3.UP, new short[0], new short[0], new byte[0], new byte[0]), new EntityDatatableMessage(0, TEST_SERIALIZED_DATA, DeltaMap.DeltaType.SET), new LoginMessage("Spouty", 0), new SyncedMapMessage(0, SyncedMapEvent.Action.ADD, new ArrayList<Pair<Integer, String>>()), new WorldChangeMessage("world", EngineFaker.TEST_UUID, TEST_TRANSFORM, TEST_SERIALIZED_DATA, DeltaMap.DeltaType.SET), new UpdateEntityMessage(0, TEST_TRANSFORM, UpdateEntityMessage.UpdateAction.TRANSFORM, new NullRepositionManager()), new ChunkDatatableMessage("Blank", 0, 0, 0, biomeData1, DeltaMap.DeltaType.SET), ReadyMessage.INSTANCE };
>>>>>>> YOURS
