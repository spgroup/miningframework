...
public class cgBase {
    ...
    public static boolean isEmpty(String[] a) {
        if (a == null)
            return true;
        for (String s : a) if (s != null && s.length() > 0)
            return false;
        return true;
    }
    ...
    public cgCacheWrap parseCache(String page, int reason) {
        ...
        try {
            final Matcher matcherLog = patternLog.matcher(page);
    ...
    public int postLog(cgeoapplication app, String geocode, String cacheid, String[] viewstates, int logType, int year, int month, int day, String log, ArrayList<cgTrackableLog> trackables) {
        if (isEmpty(viewstates)) {
