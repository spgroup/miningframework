...
public class JSR166TestCase extends TestCase {
    ...
    public static <ExtraData> Test jdk8ParameterizedTestSuite(Class<? extends JSR166TestCase> testClass, Class<ExtraData> dataClass, ExtraData data) {
        if (atLeastJava8()) {
            ...
            try {
                return (Test) Class.forName(name8).getMethod("testSuite", dataClass).invoke(null, data);
            } catch (ReflectiveOperationException e) {
                throw new AssertionError(e);
            }
        } else {
        ...
        for (Runnable throwingAction : throwingActions) {
            ...
            try {
                ...
                if (!expectedExceptionClass.isInstance(t))
                    throw new AssertionError("Expected " + expectedExceptionClass.getName() + ", got " + t.getClass().getName(), t);
            }
            if (!threw)
